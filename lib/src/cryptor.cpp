...
fb::cryptor::cryptor() :
    cryptor(0, (uint8_t*)"NexonInc.")
{ }

fb::cryptor::cryptor(uint8_t types, const uint8_t* key) :
    _type(types)
{
...
fb::cryptor::cryptor(const cryptor& crt) :
    cryptor(crt._type, crt._key)
{ }
...
void fb::cryptor::crypt(const uint8_t* src, uint8_t* dst, uint32_t size, const uint8_t* key, uint32_t ksize)
{
