...
{
    me.send(fb_resp::dialog_menu(npc, menus, message));
}
...
void context::on_dialog(character&                      me,
                        ...
                        bool                            button_prev)
{
    me.send(fb_resp::dialog_list(npc, menus, message, button_prev));
}
...
{
    me.send(fb_resp::dialog_ch_list(npc, preset, menus, message, button_prev));
}
...
{
    me.send(fb_resp::dialog_slot(npc, item_slots, message));
}
...
void context::on_dialog(character&            me,
                        ...
                        bool                  prev)
{
    me.send(fb_resp::dialog_input_ext(npc, message, top, bottom, maxlen, prev));
}