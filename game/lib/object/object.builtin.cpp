...
{"dialog",              object::builtin_dialog},
{"list",                object::builtin_list},
{"input",               object::builtin_input},
{"menu",                object::builtin_menu},
{"item",                object::builtin_item},
{"slot",                object::builtin_slot},
...
int fb::game::object::builtin_dialog(lua_State* L)
{
    ...
    if (listener != nullptr)
        listener->on_dialog(*ch, obj->_model, message, button_prev, button_next, obj->sequence());
...
int fb::game::object::builtin_list(lua_State* L)
{
    auto lua = fb::lua::get(L);
    if (lua == nullptr)
        return 0;
    ...
    {
        if (custom_preset)
            listener->on_dialog(*ch, obj->_model, message, menus, button_prev, preset, obj->sequence());
        else
            listener->on_dialog(*ch, obj->_model, message, menus, button_prev, obj->sequence());
    }
...
int fb::game::object::builtin_input(lua_State* L)
{
    ...
    if (argc > 3)
    {
        ...
        if (listener != nullptr)
            listener->on_dialog(*ch, obj->_model, message, message_top, message_bot, maxlen, prev, obj->sequence());
    }
    else
    {
        if (listener != nullptr)
            listener->on_dialog(*ch, obj->_model, message, obj->sequence());
    }
...
int fb::game::object::builtin_menu(lua_State* L)
{
    ...
    auto listener = ch->get_listener<fb::game::character>();
    if (listener != nullptr)
        listener->on_dialog(*ch, obj->_model, message, menus, obj->sequence());
...
int fb::game::object::builtin_item(lua_State* L)
{
    ...
    auto listener = ch->get_listener<fb::game::character>();
    if (listener != nullptr)
        listener->on_dialog(*ch, obj->_model, message, items, obj->sequence());
...
int fb::game::object::builtin_slot(lua_State* L)
{
    auto lua = fb::lua::get(L);
    if (lua == nullptr)
        return 0;
    ...
    auto listener = ch->get_listener<fb::game::character>();
    if (listener != nullptr)
        listener->on_dialog(*ch, obj->_model, message, slots, obj->sequence());
