...
public:
    void                        send(const fb::ostream& stream, bool encrypt, bool wrap = true, bool async = true);
    void                        send(const fb::protocol::base::response& response, bool encrypt, bool wrap = true, bool async = true);
