...
template <typename>
constexpr bool is_unique_impl = false;
template <typename T>
constexpr bool is_unique_impl<std::unique_ptr<T>> = true;
template <typename T>
constexpr bool is_unique = is_unique_impl<std::decay_t<T>>;

template <typename>
constexpr bool is_vector_impl = false;
template <typename T>
constexpr bool is_vector_impl<std::vector<T>> = true;
template <typename T>
constexpr bool is_vector = is_vector_impl<std::decay_t<T>>;

template <typename T, typename Enabler = void>
constexpr bool is_map_impl = false;
template <typename T>
constexpr bool is_map_impl<T, std::void_t<typename T::mapped_type>> = true;
template <typename T>
constexpr bool is_map = is_map_impl<std::decay_t<T>>;

template <typename>
constexpr bool is_point_impl = false;
template <typename T>
constexpr bool is_point_impl<fb::model::point<T>> = true;
template <typename T>
constexpr bool is_point = is_point_impl<std::decay_t<T>>;

template <typename>
constexpr bool is_size_impl = false;
template <typename T>
constexpr bool is_size_impl<fb::model::size<T>> = true;
template <typename T>
constexpr bool is_size = is_size_impl<std::decay_t<T>>;

template <typename>
constexpr bool is_range_impl = false;
template <typename T>
constexpr bool is_range_impl<fb::model::range<T>> = true;
template <typename T>
constexpr bool is_range = is_range_impl<std::decay_t<T>>;

template <typename T>
inline static T build(const Json::Value& json);
template <>
int8_t build<int8_t>(const Json::Value& json);
template <>
uint8_t build<uint8_t>(const Json::Value& json);
template <>
int16_t build<int16_t>(const Json::Value& json);
template <>
uint16_t build<uint16_t>(const Json::Value& json);
template <>
int build<int>(const Json::Value& json);
template <>
uint32_t build<uint32_t>(const Json::Value& json);
template <>
int64_t build<int64_t>(const Json::Value& json);
template <>
uint64_t build<uint64_t>(const Json::Value& json);
template <>
...
template <>
datetime build<datetime>(const Json::Value& json);
template <>
timespan build<timespan>(const Json::Value& json);
template <>
...
public:
    dsl(fb::model::enum_value::DSL header, const std::vector<std::any>& params) :
        header(header),
        params(params)
    { }
    dsl(const Json::Value& json) :
        header(build<fb::model::enum_value::DSL>(json["Type"])),
        params(parse_params(json))
    { }
    ~dsl()
    { }
};
...
inline std::vector<std::any> fb::model::dsl::parse_params(const Json::Value& json)
{
    static auto data = std::unordered_map<fb::model::enum_value::DSL, std::function<std::vector<std::any>(const Json::Value&)>>{
        {       fb::model::enum_value::DSL::admin,
         [](const Json::Value& json) {
         return fb::model::dsl::admin(json).to_dsl().params;
         }                                          },
        {     fb::model::enum_value::DSL::class_t,
         [](const Json::Value& json) {
         return fb::model::dsl::class_t(json).to_dsl().params;
         }                                          },
        {  fb::model::enum_value::DSL::dexteritry,
         [](const Json::Value& json) {
         return fb::model::dsl::dexteritry(json).to_dsl().params;
         }                                          },
        {fb::model::enum_value::DSL::intelligence,
         [](const Json::Value& json) {
         return fb::model::dsl::intelligence(json).to_dsl().params;
         }                                          },
        {        fb::model::enum_value::DSL::item,
         [](const Json::Value& json) {
         return fb::model::dsl::item(json).to_dsl().params;
         }                                          },
        {       fb::model::enum_value::DSL::level,
         [](const Json::Value& json) {
         return fb::model::dsl::level(json).to_dsl().params;
         }                                          },
        {         fb::model::enum_value::DSL::map,
         [](const Json::Value& json) {
         return fb::model::dsl::map(json).to_dsl().params;
         }                                          },
        {   fb::model::enum_value::DSL::promotion,
         [](const Json::Value& json) {
         return fb::model::dsl::promotion(json).to_dsl().params;
         }                                          },
        {         fb::model::enum_value::DSL::sex,
         [](const Json::Value& json) {
         return fb::model::dsl::sex(json).to_dsl().params;
         }                                          },
        {    fb::model::enum_value::DSL::strength,
         [](const Json::Value& json) {
         return fb::model::dsl::strength(json).to_dsl().params;
         }                                          },
        {       fb::model::enum_value::DSL::world, [](const Json::Value& json) {
 return fb::model::dsl::world(json).to_dsl().params;
 }}
    };
...
public:
    equipment(const Json::Value& json) :
        fb::model::item(json),
...
public:
    armor(const Json::Value& json) :
        fb::model::equipment(json)
...
public:
    auxiliary(const Json::Value& json) :
        fb::model::equipment(json)
...
protected:
    kv_container(const std::string& fname) :
        _fname(fname)
    { }
...
protected:
    array_container(const std::string& fname) :
        _fname(fname)
    { }
...
{
public:
    iterator(const typename std::vector<std::unique_ptr<T>>::iterator& i) :
        std::vector<std::unique_ptr<T>>::iterator(i)
    { }
    ~iterator() = default;
...
{
public:
    const_iterator(const typename std::vector<std::unique_ptr<T>>::const_iterator& i) :
        std::vector<std::unique_ptr<T>>::const_iterator(i)
    { }
...
#else
    __ability() :
        fb::model::kv_container<fb::model::enum_value::CLASS, fb::model::kv_container<uint8_t, fb::model::ability>>(std::string("json/ability.json"))
    { }
...
#else
    __ability_attribute() :
        fb::model::kv_container<fb::model::enum_value::CLASS, fb::model::ability_attribute>(std::string("json/ability_attribute.json"))
    { }
...
#else
    __board() :
        fb::model::kv_container<uint32_t, fb::model::board>(std::string("json/board.json"))
    { }
...
#else
    __buy() :
        fb::model::kv_container<uint32_t, fb::model::kv_container<uint32_t, fb::model::buy>>(std::string("json/buy.json"))
    { }
...
#else
    __buy_attribute() :
        fb::model::kv_container<uint32_t, fb::model::buy_attribute>(std::string("json/buy_attribute.json"))
    { }
...
#else
    __door() :
        fb::model::kv_container<uint32_t, fb::model::door>(std::string("json/door.json"))
    { }
...
#else
    __door_pair() :
        fb::model::kv_container<uint32_t, fb::model::door_pair>(std::string("json/door_pair.json"))
    { }
...
#else
    __drop() :
        fb::model::kv_container<std::string, fb::model::drop>(std::string("json/drop.json"))
    { }
...
#else
    __equipment() :
        fb::model::kv_container<uint32_t, fb::model::equipment>(std::string("json/equipment.json"))
    { }
...
#else
    __item() :
        fb::model::kv_container<uint32_t, fb::model::item>(std::string("json/item.json"))
    { }
...
#else
    __life() :
        fb::model::array_container<fb::model::life>(std::string("json/life.json"))
    { }
...
#else
    __map() :
        fb::model::kv_container<uint32_t, fb::model::map>(std::string("json/map.json"))
    { }
...
#else
    __mob() :
        fb::model::kv_container<uint32_t, fb::model::mob>(std::string("json/mob.json"))
    { }
...
#else
    __mob_spawn() :
        fb::model::kv_container<uint32_t, fb::model::array_container<fb::model::mob_spawn>>(std::string("json/mob_spawn.json"))
    { }
...
public:
    ...
    __mob_spawn_attribute() :
        fb::model::kv_container<uint32_t, fb::model::mob_spawn_attribute>(std::string("json/mob_spawn_attribute.json"))
    { }
...
#else
    __npc() :
        fb::model::kv_container<uint32_t, fb::model::npc>(std::string("json/npc.json"))
    { }
...
#else
    __npc_spawn() :
        fb::model::kv_container<uint32_t, fb::model::array_container<fb::model::npc_spawn>>(std::string("json/npc_spawn.json"))
    { }
...
public:
    ...
    __npc_spawn_attribute() :
        fb::model::kv_container<uint32_t, fb::model::npc_spawn_attribute>(std::string("json/npc_spawn_attribute.json"))
    { }
...
#else
    __object() :
        fb::model::array_container<fb::model::object>(std::string("json/object.json"))
    { }
...
#else
    __promotion() :
        fb::model::kv_container<fb::model::enum_value::CLASS, fb::model::kv_container<uint8_t, fb::model::promotion>>(std::string("json/promotion.json"))
    { }
...
public:
    ...
    __promotion_attribute() :
        fb::model::kv_container<fb::model::enum_value::CLASS, fb::model::promotion_attribute>(std::string("json/promotion_attribute.json"))
    { }
...
#else
    __reward() :
        fb::model::kv_container<std::string, fb::model::reward>(std::string("json/reward.json"))
    { }
...
#else
    __sell() :
        fb::model::kv_container<uint32_t, fb::model::kv_container<uint32_t, fb::model::sell>>(std::string("json/sell.json"))
    { }
...
#else
    __sell_attribute() :
        fb::model::kv_container<uint32_t, fb::model::sell_attribute>(std::string("json/sell_attribute.json"))
    { }
...
#else
    __spell() :
        fb::model::kv_container<uint32_t, fb::model::spell>(std::string("json/spell.json"))
    { }
...
#else
    __warp() :
        fb::model::kv_container<uint32_t, fb::model::array_container<fb::model::warp>>(std::string("json/warp.json"))
    { }
...
#else
    __warp_attribute() :
        fb::model::kv_container<uint32_t, fb::model::warp_attribute>(std::string("json/warp_attribute.json"))
    { }
...
#else
    __world() :
        fb::model::kv_container<uint16_t, fb::model::kv_container<uint16_t, fb::model::world>>(std::string("json/world.json"))
    { }
...
#else
    __world_attribute() :
        fb::model::kv_container<uint16_t, fb::model::world_attribute>(std::string("json/world_attribute.json"))
    { }
...
private:
    const std::vector<fb::model::container*> _containers = {&ability,
                                                            &ability_attribute,
                                                            &board,
                                                            &buy,
                                                            &buy_attribute,
...
template <>
dsl build<dsl>(const Json::Value& json)
{
    return dsl(json);
}

template <>
date_range build<date_range>(const Json::Value& json)
{
