...
command_funcs = {
    ...
    function (me, args)
        local commands = {
            ...
            "/웹 <타입> <URL> - 웹 페이지 열기",
            "/메일쓰기 <받는사람> <제목> <내용> - 메일 전송",
            "/쿨타임초기화 - 스킬 쿨타임 초기화",
            "/금전 <금액> - 금전 설정",
            "/성전환 - 성별 변경",
            "/업적 <ID> <텍스트> [아이콘] [색상] - 업적 추가",
            "/업적초기화 - 업적 초기화",
            "/버프해제 - 모든 버프 해제",
            "/아이템삭제 - 맵의 모든 아이템 삭제",
            "/아이템초기화 - 인벤토리 아이템 초기화",
        ...
        for i, command in ipairs(commands) do
            me:message(string.format("%d. %s", i, command), MESSAGE_TYPE_BROWN)
        end
        me:message(string.format("총 %d개의 명령어가 있습니다.", #commands), MESSAGE_TYPE_BROWN)
