...
RESET:
    ...
    {
        if(@myjob == 3 && @myjoblv < 3)
        {
            setarray @hp[0], 30000, 150000, 300000, 650000;
            setarray @mp[0], 20000, 100000, 500000, 900000;
    ...
    else if(@ret == 2)
    {
        if(@myjob == 3)
        {
            ...
            if(@ret == 3 && @myjoblv >= 3)
            {
                setarray @magic$[0], "마기지체", "지폭지술", "노도성황","환기";
            ...
            if(@ret == 4 && @myjoblv >= 4)
            {
                setarray @magic$[0], "폭류유성", "현자의기원", "만파지독";
