-- Move name_registry and clan_name to unified MySQL (global unique name and id).
-- world is home-world metadata only. No FK to sharded data DBs.
...
CREATE TABLE IF NOT EXISTS `name_registry` (
  ...
  `world` int unsigned NOT NULL COMMENT 'Home world at reservation time',
...
CREATE TABLE IF NOT EXISTS `clan_name` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `world` int unsigned NOT NULL COMMENT 'Home world of the clan',
