...
void marshal_lua_game_resp__effect(lua_State* L, const fb::protocol::header& header)
{
    ...
    const auto& resp = static_cast<const game_resp::effect_v550&>(header);
    lua->new_table();
    lua->pushstring("oid");
    lua->pushinteger(resp.oid);
    lua->settable(-3);
...
void marshal_lua_game_resp__item_tip(lua_State* L, const fb::protocol::header& header)
{
    ...
    const auto& resp = static_cast<const game_resp::item_tip_v550&>(header);
    lua->new_table();
...
void marshal_lua_game_resp__web(lua_State* L, const fb::protocol::header& header)
{
    ...
    const auto& resp = static_cast<const game_resp::web_v550&>(header);
    lua->new_table();
    lua->pushstring("type");
    lua->pushinteger(resp.type);
    lua->settable(-3);
