...
dialog_email<V>::dialog_email(const fb::model::object& obj,
...
template <CLIENT_VERSION V>
dialog_email<V>::dialog_email(const fb::game::object& object,
                              std::string_view        message,
                              std::string_view        str1,
                              std::string_view        str2,
                              bool                    button_prev,
...
template <CLIENT_VERSION V>
dialog_email<V>::dialog_email(appearance_ptr&& appearance,
                              std::string_view message,
                              std::string_view str1,
                              std::string_view str2,
                              bool             button_prev,
...
template <CLIENT_VERSION V>
void dialog_email<V>::serialize(fb::stream_writer<big_endian>& writer) const
{
...
template class dialog_email<CLIENT_VERSION::v550>;
template class dialog_email<CLIENT_VERSION::v565>;
template class dialog_email<CLIENT_VERSION::v651>;
#else
