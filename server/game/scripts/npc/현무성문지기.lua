-- Gatekeeper for Hyeonmu (Turtle) castle. Implements KONGSUNG behavior:
-- greets, offers entrance; allows warp by clan/siege state (see clan_castle_* globals).

local TOTEM = '현무'
local TOTEM_KEY = 'turtle'
...
--- Handles click on Hyeonmu castle gatekeeper NPC.
--- @param me table Character that clicked
--- @param npc table Gatekeeper NPC
function NPC_225(me, npc)
