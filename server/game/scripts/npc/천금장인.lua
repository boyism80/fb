...
function NPC_139(me, npc)
    ::NPC_139_0000::
    local sel, btn = me:list(npc, '안녕하세요. 어떻게 오셨나요?', { '하급 용무기 각성' }, false)
    ...
    ::NPC_139_0004::
    local confirm_sel, confirm_btn = me:list(npc, '사람이 하는 일에 완전은 있을 수 없다네. 용의 기운은 미묘하여, 하늘, 땅, 그리고 사람의 기운중 하나가 조금이라도 어긋나면 용무기는 깨져버릴 것이네. 자네는 실패의 위험을 무릎쓰고서 용무기를 각성시키려는가?', { '예, 진인사재천명! 하늘에 뜻에 맡기겠습니다.', '아니요, 내 귀한 용무기를 시험에 들게할 순 없죠.' }, true)
