-- @note Trash: 1_극지방\설원지방.txt "설원조합사3". Craft 활력의귀걸이 from 눈꽃얼음 50 (20% success); materials consumed either way.
...
---@brief NPC 설원조합사3: craft 활력의귀걸이 from 눈꽃얼음 50 (20% success).
---@param[in] me  The character.
---@param[in] npc The NPC entity.
