...
function NPC_369(me, npc)
    ...
    button = me:dialog(npc, "지금 바로 도삭산 비밀의방으로 보내주겠네.", { prev = false, next = true })
    if button == DIALOG_RESULT.QUIT then
        return
    end
