-- @note Trash: 1_부여성\부여놀이방.txt "부윷일". Yut-nori: pay 10 zeny, random result (도/개/걸/윷/모/빽도).
...
-- @brief   NPC 부윷일: yut-nori (pay 10 zeny, random result).
-- @param[in]  me   The character talking to the NPC.
-- @param[in]  npc  The NPC entity (부윷일).
function NPC_285(me, npc)
