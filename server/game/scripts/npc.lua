...
::NPC_BASIC_CLASS.002::
            ...
            if selected ~= 0 then
                goto NPC_BASIC_CLASS.STOP
            end
            if button == DIALOG_RESULT.QUIT then
                return
            end
            if button == DIALOG_RESULT.PREV then
                goto NPC_BASIC_CLASS.001
            end
::NPC_BASIC_CLASS.003::
