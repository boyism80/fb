...
function ON_ACTIVE_4(me, item)
    ...
    if quest == nil or quest:completed() then
        ...
        if quest == nil and not me:start_quest(QUEST_NAKRANG4) then
            return
        end
        quest = me:quest(QUEST_NAKRANG4)
        quest:step(1)
        return
    end
