...
function ON_ACTIVATED_8(me, item)
    ...
    if map == nil then
        me:dialog(model, '존재하지 않는 맵입니다.', { prev = false, next = false })
        return
    end
