...
async::task<void> server::upsert_clan_then(uint32_t                                                           id,
...
async::task<void>
server::change_clan_member_role(const clan& clan, uint32_t changer_uid, const std::string& target, CLAN_ROLE role)
{
