...
async::task<bool> server::npc_interaction_sell(character&                                         ch,
...
async::task<bool> server::npc_interaction_buy(character&                                         ch,
                                              const std::string&                                 message,
                                              const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_repair(character&                                         ch,
                                                 const std::string&                                 message,
                                                 const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_deposit_money(character&                                         ch,
                                                        const std::string&                                 message,
                                                        const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_withdraw_money(character&                                         ch,
                                                         const std::string&                                 message,
                                                         const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_store_item(character&                                         ch,
                                                     const std::string&                                 message,
                                                     const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_retrieve_item(character&                                         ch,
                                                        const std::string&                                 message,
                                                        const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_sell_list(character&                                         ch,
                                                    const std::string&                                 message,
                                                    const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_buy_list(character&                                         ch,
                                                   const std::string&                                 message,
                                                   const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_sell_price(character&                                         ch,
                                                     const std::string&                                 message,
                                                     const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_buy_price(character&                                         ch,
                                                    const std::string&                                 message,
                                                    const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_show_deposited_money(character&         ch,
                                                               const std::string& message,
                                                               const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_rename_weapon(character&                                         ch,
                                                        const std::string&                                 message,
                                                        const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_store_item_list(character&                                         ch,
                                                          const std::string&                                 message,
                                                          const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_store_item_count(character&                                         ch,
                                                           const std::string&                                 message,
                                                           const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_revive(character&                                         ch,
                                                 const std::string&                                 message,
                                                 const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
...
async::task<bool> server::npc_interaction_appreciate(character&                                         ch,
                                                     const std::string&                                 message,
                                                     const std::vector<std::shared_ptr<fb::game::npc>>& npcs)
{
    ch.assert_thread();
