...
fb::game::handler::dialog::dialog(fb::game::server& server) :
    fb::handler<fb::game::server, fb::protocol::game::request::dialog>(server)
{ }

async::task<bool> fb::game::handler::dialog::handle(fb::socket<character>&               session,
