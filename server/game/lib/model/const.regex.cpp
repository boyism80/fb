...
bool fb::model::const_value::regex::match_store_item_list(const std::string& message)
{
...
bool fb::model::const_value::regex::match_store_item_count(const std::string& message, std::string& item)
{
