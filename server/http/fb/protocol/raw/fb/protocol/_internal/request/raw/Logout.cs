...
public struct Logout : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.request.raw.Logout> CreateLogout(FlatBufferBuilder builder,
    ...
    Logout.AddSection(builder, sectionOffset);
  ...
  public static void FinishLogoutBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.request.raw.Logout> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedLogoutBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.request.raw.Logout> offset) { builder.FinishSizePrefixed(offset.Value); }
}
