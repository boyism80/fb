...
public struct BroadcastClan : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.request.raw.BroadcastClan> CreateBroadcastClan(FlatBufferBuilder builder,
    ...
    BroadcastClan.AddHost(builder, host);
    BroadcastClan.AddSection(builder, sectionOffset);
    BroadcastClan.AddType(builder, type);
    return BroadcastClan.EndBroadcastClan(builder);
  }

  public static void StartBroadcastClan(FlatBufferBuilder builder) { builder.StartTable(5); }
