...
public struct Broadcast : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.response.raw.Broadcast> CreateBroadcast(FlatBufferBuilder builder,
      uint host = 0,
      StringOffset messageOffset = default(StringOffset),
      byte type = 0,
      uint error = 0) {
    builder.StartTable(4);
    Broadcast.AddError(builder, error);
  ...
  public static Offset<fb.protocol._internal.response.raw.Broadcast> EndBroadcast(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.response.raw.Broadcast>(o);
  }
  public static void FinishBroadcastBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.Broadcast> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedBroadcastBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.Broadcast> offset) { builder.FinishSizePrefixed(offset.Value); }
}
