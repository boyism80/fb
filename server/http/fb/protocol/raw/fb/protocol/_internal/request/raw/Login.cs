...
public struct Login : IFlatbufferObject
{
  ...
  public bool Force { get { int o = __p.__offset(10); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  ...
  public static void AddForce(FlatBufferBuilder builder, bool force) { builder.AddBool(3, force, false); }
  ...
  public static void FinishLoginBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.request.raw.Login> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedLoginBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.request.raw.Login> offset) { builder.FinishSizePrefixed(offset.Value); }
}
...
static public class LoginVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Force*/, 1 /*bool*/, 1, false)
