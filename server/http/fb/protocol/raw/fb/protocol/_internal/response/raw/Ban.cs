...
public struct Ban : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.response.raw.Ban> CreateBan(FlatBufferBuilder builder,
      StringOffset nameOffset = default(StringOffset),
      StringOffset reasonOffset = default(StringOffset),
      StringOffset expire_dateOffset = default(StringOffset),
      uint error = 0) {
    builder.StartTable(4);
    Ban.AddError(builder, error);
    Ban.AddExpireDate(builder, expire_dateOffset);
  ...
  public static Offset<fb.protocol._internal.response.raw.Ban> EndBan(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.response.raw.Ban>(o);
  }
  public static void FinishBanBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.Ban> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedBanBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.Ban> offset) { builder.FinishSizePrefixed(offset.Value); }
}
