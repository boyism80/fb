...
public struct MakeCharacter : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.response.raw.MakeCharacter> CreateMakeCharacter(FlatBufferBuilder builder,
      bool success = false) {
    builder.StartTable(1);
    MakeCharacter.AddSuccess(builder, success);
    return MakeCharacter.EndMakeCharacter(builder);
  }

  public static void StartMakeCharacter(FlatBufferBuilder builder) { builder.StartTable(1); }
  public static void AddSuccess(FlatBufferBuilder builder, bool success) { builder.AddBool(0, success, false); }
  public static Offset<fb.protocol._internal.response.raw.MakeCharacter> EndMakeCharacter(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.response.raw.MakeCharacter>(o);
  }
  public static void FinishMakeCharacterBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.MakeCharacter> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedMakeCharacterBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.MakeCharacter> offset) { builder.FinishSizePrefixed(offset.Value); }
}
