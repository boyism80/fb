...
namespace Http.Service
{
    public abstract class GenericCacheService<T> where T : class
    {
        ...
        public async Task<T> GetAsync(uint world, Func<Task<T>> dbQueryFunc, TimeSpan? ttl = null, params object[] parameters)
        {
        ...
        public async Task SetAsync(uint world, T value, TimeSpan? ttl = null, params object[] parameters)
        {
            var cacheKey = GenerateCacheKey(parameters);
            var hashForSharding = GetHashForSharding(cacheKey, parameters);
        ...
        public async Task DeleteAsync(uint world, params object[] parameters)
        {
            var cacheKey = GenerateCacheKey(parameters);
            var hashForSharding = GetHashForSharding(cacheKey, parameters);
        ...
        public async Task SetBatchAsync(uint world, Dictionary<object[], T> items, TimeSpan? ttl = null)
        {
        ...
        public async Task DeleteBatchAsync(uint world, IEnumerable<object[]> parametersList)
        {
