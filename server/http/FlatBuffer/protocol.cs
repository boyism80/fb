...
namespace fb.protocol._internal
{
    public static class FlatBufferBuilderEx
    {
        ...
        public static Offset<fb.protocol.marketplace.request.raw.AllocateListingId> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.AllocateListingId value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.AllocateListingId.CreateAllocateListingId(builder,
        ...
        public static Offset<fb.protocol.marketplace.request.raw.CheckListingStatus> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.CheckListingStatus value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.CheckListingStatus.CreateCheckListingStatus(builder,
                builder.Build(value.ListingId));
        }
        ...
        public static Offset<fb.protocol.marketplace.response.raw.AllocateListingId> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.AllocateListingId value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.AllocateListingId.CreateAllocateListingId(builder,
                builder.Build(value.ListingId),
                builder.Build(value.Error));
        }
        ...
        public static Offset<fb.protocol.marketplace.response.raw.CheckListingStatus> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.CheckListingStatus value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.CheckListingStatus.CreateCheckListingStatus(builder,
                builder.Build(value.ListingId),
                builder.Build(value.Error));
        }
...
namespace fb.protocol.marketplace
{
    ...
    public class SearchResult : IFlatBufferEx
    {
        ...
        {
            Listings = Enumerable.Range(0, raw.ListingsLength).Select(i => raw.Listings(i)).Select(x => new Listing(x.Value)).ToList();
...
namespace fb.protocol.marketplace.request
{
    ...
    public class AllocateListingId : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.AllocateListingId;
        public uint CharacterId { get; set; } = 0;

        public AllocateListingId()
        { }

        public AllocateListingId(fb.protocol.marketplace.request.raw.AllocateListingId raw)
        {
            CharacterId = raw.CharacterId;
        }

        public AllocateListingId(byte[] bytes) : this(fb.protocol.marketplace.request.raw.AllocateListingId.GetRootAsAllocateListingId(new ByteBuffer(bytes)))
        { }
        ...
        public static AllocateListingId Deserialize(byte[] bytes)
        {
            return new AllocateListingId(bytes);
        }
    }
    ...
    public class CheckListingStatus : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.CheckListingStatus;
        public string ListingId { get; set; } = string.Empty;

        public CheckListingStatus()
        { }

        public CheckListingStatus(fb.protocol.marketplace.request.raw.CheckListingStatus raw)
        {
            ListingId = raw.ListingId;
        }

        public CheckListingStatus(byte[] bytes) : this(fb.protocol.marketplace.request.raw.CheckListingStatus.GetRootAsCheckListingStatus(new ByteBuffer(bytes)))
        { }
        ...
        public static CheckListingStatus Deserialize(byte[] bytes)
        {
            return new CheckListingStatus(bytes);
        }
    }
    ...
    public static class FlatBufferProtocolRouter
    {
        public static Type GetProtocolType(FlatBufferProtocolType protocolType)
        {
            return protocolType switch
            {
                FlatBufferProtocolType.AllocateListingId => typeof(fb.protocol.marketplace.request.AllocateListingId),
                ...
                FlatBufferProtocolType.CheckListingStatus => typeof(fb.protocol.marketplace.request.CheckListingStatus),
...
namespace fb.protocol.marketplace.response
{
    ...
    public class AllocateListingId : IFlatBufferEx
    {
        ...
        public AllocateListingId(fb.protocol.marketplace.response.raw.AllocateListingId raw)
        {
            ListingId = raw.ListingId;
            Error = raw.Error;
        }

        public AllocateListingId(byte[] bytes) : this(fb.protocol.marketplace.response.raw.AllocateListingId.GetRootAsAllocateListingId(new ByteBuffer(bytes)))
        { }
    ...
    public class Search : IFlatBufferEx
    {
        ...
        {
            Result = new SearchResult(raw.Result.Value);
            Error = raw.Error;
        }
    ...
    public class CheckListingStatus : IFlatBufferEx
    {
        ...
        public CheckListingStatus(fb.protocol.marketplace.response.raw.CheckListingStatus raw)
        {
            ListingId = raw.ListingId;
            Error = raw.Error;
        }

        public CheckListingStatus(byte[] bytes) : this(fb.protocol.marketplace.response.raw.CheckListingStatus.GetRootAsCheckListingStatus(new ByteBuffer(bytes)))
        { }
    ...
    public static class FlatBufferProtocolRouter
    {
        public static Type GetProtocolType(FlatBufferProtocolType protocolType)
        {
            return protocolType switch
            {
                FlatBufferProtocolType.AllocateListingId => typeof(fb.protocol.marketplace.response.AllocateListingId),
                ...
                FlatBufferProtocolType.CheckListingStatus => typeof(fb.protocol.marketplace.response.CheckListingStatus),
