...
namespace fb.protocol._internal
{
    public static class FlatBufferBuilderEx
    {
        ...
        public static Offset<fb.protocol._internal.raw.SystemMailUser> Build(this FlatBufferBuilder builder, fb.protocol._internal.SystemMailUser value)
        {
            if (value == null)
                return default;

            return fb.protocol._internal.raw.SystemMailUser.CreateSystemMailUser(builder,
                builder.Build(value.User),
                builder.Build(value.MailId),
                builder.Build(value.Read),
                builder.Build(value.ExpireDate));
        }
        ...
        public static Offset<fb.protocol._internal.raw.StoragePendingBox> Build(this FlatBufferBuilder builder, fb.protocol._internal.StoragePendingBox value)
        {
            if (value == null)
                return default;

            return fb.protocol._internal.raw.StoragePendingBox.CreateStoragePendingBox(builder,
                builder.Build(value.Id),
                builder.Build(value.User),
                builder.Build(value.Title),
                builder.Build(value.Message),
        ...
        public static Offset<fb.protocol._internal.raw.StorageRewardMark> Build(this FlatBufferBuilder builder, fb.protocol._internal.StorageRewardMark value)
        {
            if (value == null)
                return default;

            return fb.protocol._internal.raw.StorageRewardMark.CreateStorageRewardMark(builder,
                builder.Build(value.User),
                builder.Build(value.PendingId),
                builder.Build(value.ExpiredDate));
        }
        ...
        public static Offset<fb.protocol._internal.request.raw.Save> Build(this FlatBufferBuilder builder, fb.protocol._internal.request.Save value)
        {
            ...
            return fb.protocol._internal.request.raw.Save.CreateSave(builder,
                ...
                builder.Build(value.ReceivedSystemMails),
                builder.Build(value.StorageBoxes),
                builder.Build(value.StorageRewardMarks));
        }
        ...
        public static Offset<fb.protocol._internal.request.raw.GetStoragePending> Build(this FlatBufferBuilder builder, fb.protocol._internal.request.GetStoragePending value)
        {
            if (value == null)
                return default;
        ...
        public static Offset<fb.protocol._internal.response.raw.Init> Build(this FlatBufferBuilder builder, fb.protocol._internal.response.Init value)
        {
            ...
            return fb.protocol._internal.response.raw.Init.CreateInit(builder,
                ...
                builder.Build(value.StorageBoxes),
                builder.Build(value.StorageRewardMarks),
                builder.Build(value.StoragePending),
                builder.Build(value.Mail));
        }
        ...
        public static Offset<fb.protocol._internal.response.raw.GetStoragePending> Build(this FlatBufferBuilder builder, fb.protocol._internal.response.GetStoragePending value)
        {
            if (value == null)
                return default;

            return fb.protocol._internal.response.raw.GetStoragePending.CreateGetStoragePending(builder,
                builder.Build(value.User),
                builder.Build(value.Pending),
                builder.Build(value.Error));
        }
        ...
        public static Offset<fb.protocol.marketplace.raw.MarketplaceItem> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.MarketplaceItem value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.raw.MarketplaceItem.CreateMarketplaceItem(builder,
        ...
        public static Offset<fb.protocol.marketplace.raw.MarketplaceListing> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.MarketplaceListing value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.raw.MarketplaceListing.CreateMarketplaceListing(builder,
                builder.Build(value.Id),
                builder.Build(value.SellerId),
                builder.Build(value.Item),
                builder.Build(value.Price),
                builder.Build(value.ListingFee),
                builder.Build(value.TransactionFee),
                builder.Build(value.ExpireDate),
                builder.Build(value.CreatedDate));
        }
        public static Offset<fb.protocol.marketplace.raw.MarketplaceSearchResult> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.MarketplaceSearchResult value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.raw.MarketplaceSearchResult.CreateMarketplaceSearchResult(builder,
                builder.Build(value.Listings),
                builder.Build(value.TotalCount),
                builder.Build(value.Page),
                builder.Build(value.PageSize));
        }
        public static Offset<fb.protocol.marketplace.raw.PendingTransaction> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.PendingTransaction value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.raw.PendingTransaction.CreatePendingTransaction(builder,
                builder.Build(value.Id),
                builder.Build(value.ListingId),
                builder.Build(value.BuyerId),
                builder.Build(value.SellerId),
                builder.Build(value.ItemModel),
                builder.Build(value.ItemCount),
                builder.Build(value.Price),
                builder.Build(value.SellerRevenue),
                builder.Build(value.CreatedDate));
        }
        public static Offset<fb.protocol.marketplace.raw.PendingReturn> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.PendingReturn value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.raw.PendingReturn.CreatePendingReturn(builder,
                builder.Build(value.Id),
                builder.Build(value.ListingId),
                builder.Build(value.SellerId),
                builder.Build(value.ItemModel),
                builder.Build(value.ItemCount),
                builder.Build(value.ItemDurability),
                builder.Build(value.ItemCustomName),
                builder.Build(value.CreatedDate));
        }
        public static Offset<fb.protocol.marketplace.request.raw.MarketplaceList> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.MarketplaceList value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.MarketplaceList.CreateMarketplaceList(builder,
                builder.Build(value.CharacterId),
                builder.Build(value.RequestId),
                builder.Build(value.Item),
                builder.Build(value.Price),
                builder.Build(value.ExpireHours));
        }
        public static Offset<fb.protocol.marketplace.request.raw.MarketplaceCancel> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.MarketplaceCancel value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.MarketplaceCancel.CreateMarketplaceCancel(builder,
                builder.Build(value.CharacterId),
                builder.Build(value.ListingId));
        }
        public static Offset<fb.protocol.marketplace.request.raw.MarketplacePurchase> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.MarketplacePurchase value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.MarketplacePurchase.CreateMarketplacePurchase(builder,
                builder.Build(value.BuyerId),
                builder.Build(value.ListingId),
                builder.Build(value.RequestId));
        }
        public static Offset<fb.protocol.marketplace.request.raw.MarketplaceSearch> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.MarketplaceSearch value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.MarketplaceSearch.CreateMarketplaceSearch(builder,
        ...
        public static Offset<fb.protocol.marketplace.request.raw.MarketplaceCheckListingStatus> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.MarketplaceCheckListingStatus value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.MarketplaceCheckListingStatus.CreateMarketplaceCheckListingStatus(builder,
                builder.Build(value.RequestId));
        }
        public static Offset<fb.protocol.marketplace.request.raw.MarketplaceGetPendingTransactions> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.MarketplaceGetPendingTransactions value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.MarketplaceGetPendingTransactions.CreateMarketplaceGetPendingTransactions(builder,
                builder.Build(value.CharacterId),
                builder.Build(value.Type));
        }
        public static Offset<fb.protocol.marketplace.request.raw.MarketplaceCompletePendingTransaction> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.MarketplaceCompletePendingTransaction value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.MarketplaceCompletePendingTransaction.CreateMarketplaceCompletePendingTransaction(builder,
                builder.Build(value.TransactionId));
        }
        public static Offset<fb.protocol.marketplace.request.raw.MarketplaceCompletePendingReturn> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.request.MarketplaceCompletePendingReturn value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.request.raw.MarketplaceCompletePendingReturn.CreateMarketplaceCompletePendingReturn(builder,
                builder.Build(value.ReturnId));
        }
        public static Offset<fb.protocol.marketplace.response.raw.MarketplaceList> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.MarketplaceList value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.MarketplaceList.CreateMarketplaceList(builder,
                builder.Build(value.Success),
                builder.Build(value.ListingId),
                builder.Build(value.ListingFee),
                builder.Build(value.RequestId),
        ...
        public static Offset<fb.protocol.marketplace.response.raw.MarketplaceCancel> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.MarketplaceCancel value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.MarketplaceCancel.CreateMarketplaceCancel(builder,
                builder.Build(value.Success),
                builder.Build(value.Error));
        }
        public static Offset<fb.protocol.marketplace.response.raw.MarketplacePurchase> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.MarketplacePurchase value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.MarketplacePurchase.CreateMarketplacePurchase(builder,
                builder.Build(value.Success),
                builder.Build(value.Item),
                builder.Build(value.Error));
        }
        public static Offset<fb.protocol.marketplace.response.raw.MarketplaceSearch> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.MarketplaceSearch value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.MarketplaceSearch.CreateMarketplaceSearch(builder,
                builder.Build(value.Success),
                builder.Build(value.Result),
                builder.Build(value.Error));
        }
        public static Offset<fb.protocol.marketplace.response.raw.MarketplaceCheckListingStatus> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.MarketplaceCheckListingStatus value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.MarketplaceCheckListingStatus.CreateMarketplaceCheckListingStatus(builder,
                builder.Build(value.Success),
                builder.Build(value.ListingId),
                builder.Build(value.ListingFee),
                builder.Build(value.Error));
        }
        public static Offset<fb.protocol.marketplace.response.raw.MarketplaceGetPendingTransactions> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.MarketplaceGetPendingTransactions value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.MarketplaceGetPendingTransactions.CreateMarketplaceGetPendingTransactions(builder,
                builder.Build(value.Success),
                builder.Build(value.Transactions),
                builder.Build(value.Returns),
                builder.Build(value.Error));
        }
        public static Offset<fb.protocol.marketplace.response.raw.MarketplaceCompletePendingTransaction> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.MarketplaceCompletePendingTransaction value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.MarketplaceCompletePendingTransaction.CreateMarketplaceCompletePendingTransaction(builder,
                builder.Build(value.Success));
        }
        public static Offset<fb.protocol.marketplace.response.raw.MarketplaceCompletePendingReturn> Build(this FlatBufferBuilder builder, fb.protocol.marketplace.response.MarketplaceCompletePendingReturn value)
        {
            if (value == null)
                return default;

            return fb.protocol.marketplace.response.raw.MarketplaceCompletePendingReturn.CreateMarketplaceCompletePendingReturn(builder,
                builder.Build(value.Success));
        }
        ...
        public static VectorOffset Build(this FlatBufferBuilder builder, List<fb.protocol._internal.SystemMailUser> value)
        {
            return builder.CreateVectorOfTables<fb.protocol._internal.raw.SystemMailUser>(value.Select(x => Build(builder, x)).ToArray());
        }
        ...
        public static VectorOffset Build(this FlatBufferBuilder builder, List<fb.protocol._internal.StorageRewardMark> value)
        {
            return builder.CreateVectorOfTables<fb.protocol._internal.raw.StorageRewardMark>(value.Select(x => Build(builder, x)).ToArray());
        }
        ...
        public static VectorOffset Build(this FlatBufferBuilder builder, List<fb.protocol._internal.StoragePendingBox> value)
        {
            return builder.CreateVectorOfTables<fb.protocol._internal.raw.StoragePendingBox>(value.Select(x => Build(builder, x)).ToArray());
        }
        ...
        public static VectorOffset Build(this FlatBufferBuilder builder, List<fb.protocol.marketplace.MarketplaceListing> value)
        {
            return builder.CreateVectorOfTables<fb.protocol.marketplace.raw.MarketplaceListing>(value.Select(x => Build(builder, x)).ToArray());
        }
        public static VectorOffset Build(this FlatBufferBuilder builder, List<fb.protocol.marketplace.PendingTransaction> value)
        {
            return builder.CreateVectorOfTables<fb.protocol.marketplace.raw.PendingTransaction>(value.Select(x => Build(builder, x)).ToArray());
        }
        public static VectorOffset Build(this FlatBufferBuilder builder, List<fb.protocol.marketplace.PendingReturn> value)
        {
            return builder.CreateVectorOfTables<fb.protocol.marketplace.raw.PendingReturn>(value.Select(x => Build(builder, x)).ToArray());
        }
...
namespace fb.protocol._internal
{
    ...
    public class SystemMailUser : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.SystemMailUser;
        public uint User { get; set; } = 0;
        public uint MailId { get; set; } = 0;
        public bool Read { get; set; } = false;
        public string ExpireDate { get; set; } = null;

        public SystemMailUser()
        { }

        public SystemMailUser(fb.protocol._internal.raw.SystemMailUser raw)
        {
            User = raw.User;
            MailId = raw.MailId;
            Read = raw.Read;
        ...
        public SystemMailUser(byte[] bytes) : this(fb.protocol._internal.raw.SystemMailUser.GetRootAsSystemMailUser(new ByteBuffer(bytes)))
        { }
        ...
        public static SystemMailUser Deserialize(byte[] bytes)
        {
            return new SystemMailUser(bytes);
        }
    }
    ...
    public class StoragePendingBox : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.StoragePendingBox;
        public string Id { get; set; } = string.Empty;
        public uint? User { get; set; } = null;
        public string Title { get; set; } = string.Empty;
        public string Message { get; set; } = string.Empty;
        public string Attachments { get; set; } = string.Empty;
        public string ExpiredDate { get; set; } = null;

        public StoragePendingBox()
        { }

        public StoragePendingBox(fb.protocol._internal.raw.StoragePendingBox raw)
        {
            Id = raw.Id;
            User = raw.User != null ? (uint?)raw.User.Value.Value : null;
            Title = raw.Title;
            Message = raw.Message;
            Attachments = raw.Attachments;
            ExpiredDate = raw.ExpiredDate;
        ...
        public StoragePendingBox(byte[] bytes) : this(fb.protocol._internal.raw.StoragePendingBox.GetRootAsStoragePendingBox(new ByteBuffer(bytes)))
        { }
        ...
        public static StoragePendingBox Deserialize(byte[] bytes)
        {
            return new StoragePendingBox(bytes);
        }
    }
    public class StorageRewardMark : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.StorageRewardMark;
        public uint User { get; set; } = 0;
        public string PendingId { get; set; } = string.Empty;
        public string ExpiredDate { get; set; } = null;

        public StorageRewardMark()
        { }

        public StorageRewardMark(fb.protocol._internal.raw.StorageRewardMark raw)
        {
            User = raw.User;
        ...
        public StorageRewardMark(byte[] bytes) : this(fb.protocol._internal.raw.StorageRewardMark.GetRootAsStorageRewardMark(new ByteBuffer(bytes)))
        { }
        ...
        public static StorageRewardMark Deserialize(byte[] bytes)
        {
            return new StorageRewardMark(bytes);
        }
    }
    ...
    public static class FlatBufferProtocolRouter
    {
        public static Type GetProtocolType(FlatBufferProtocolType protocolType)
        {
            return protocolType switch
            {
                ...
                FlatBufferProtocolType.SystemMailUser => typeof(fb.protocol._internal.SystemMailUser),
                FlatBufferProtocolType.StorageBox => typeof(fb.protocol._internal.StorageBox),
                FlatBufferProtocolType.StoragePendingBox => typeof(fb.protocol._internal.StoragePendingBox),
                FlatBufferProtocolType.StorageRewardMark => typeof(fb.protocol._internal.StorageRewardMark),
...
namespace fb.protocol._internal.request
{
    ...
    public class Save : IFlatBufferEx
    {
        ...
        public List<fb.protocol._internal.SystemMailUser> ReceivedSystemMails { get; set; } = new List<fb.protocol._internal.SystemMailUser>();
        public List<fb.protocol._internal.StorageBox> StorageBoxes { get; set; } = new List<fb.protocol._internal.StorageBox>();
        public List<fb.protocol._internal.StorageRewardMark> StorageRewardMarks { get; set; } = new List<fb.protocol._internal.StorageRewardMark>();
        ...
        public Save(fb.protocol._internal.request.raw.Save raw)
        {
            ...
            Quests = Enumerable.Range(0, raw.QuestsLength).Select(i => raw.Quests(i)).Select(x => new Quest(x.Value)).ToList();
            ReceivedSystemMails = Enumerable.Range(0, raw.ReceivedSystemMailsLength).Select(i => raw.ReceivedSystemMails(i)).Select(x => new SystemMailUser(x.Value)).ToList();
            StorageBoxes = Enumerable.Range(0, raw.StorageBoxesLength).Select(i => raw.StorageBoxes(i)).Select(x => new StorageBox(x.Value)).ToList();
            StorageRewardMarks = Enumerable.Range(0, raw.StorageRewardMarksLength).Select(i => raw.StorageRewardMarks(i)).Select(x => new StorageRewardMark(x.Value)).ToList();
        }
    ...
    public class GetStoragePending : IFlatBufferEx
    {
        ...
        public GetStoragePending(byte[] bytes) : this(fb.protocol._internal.request.raw.GetStoragePending.GetRootAsGetStoragePending(new ByteBuffer(bytes)))
        { }
        ...
        public static GetStoragePending Deserialize(byte[] bytes)
        {
...
namespace fb.protocol._internal.response
{
    ...
    public class Init : IFlatBufferEx
    {
        ...
        public List<fb.protocol._internal.StorageBox> StorageBoxes { get; set; } = new List<fb.protocol._internal.StorageBox>();
        public List<fb.protocol._internal.StorageRewardMark> StorageRewardMarks { get; set; } = new List<fb.protocol._internal.StorageRewardMark>();
        public List<fb.protocol._internal.StoragePendingBox> StoragePending { get; set; } = new List<fb.protocol._internal.StoragePendingBox>();
        ...
        public Init(fb.protocol._internal.response.raw.Init raw)
        {
            ...
            StorageBoxes = Enumerable.Range(0, raw.StorageBoxesLength).Select(i => raw.StorageBoxes(i)).Select(x => new StorageBox(x.Value)).ToList();
            StorageRewardMarks = Enumerable.Range(0, raw.StorageRewardMarksLength).Select(i => raw.StorageRewardMarks(i)).Select(x => new StorageRewardMark(x.Value)).ToList();
            StoragePending = Enumerable.Range(0, raw.StoragePendingLength).Select(i => raw.StoragePending(i)).Select(x => new StoragePendingBox(x.Value)).ToList();
            Mail = raw.Mail;
        }
    ...
    public class GroupDetails : IFlatBufferEx
    {
        ...
        public GroupDetails(fb.protocol._internal.response.raw.GroupDetails raw)
        {
            ...
            Members = Enumerable.Range(0, raw.MembersLength).Select(i => raw.Members(i)).Select(x => new CharacterRef(x.Value)).ToList();
            Actor = raw.Actor;
            Target = raw.Target;
            Error = raw.Error;
        }
    ...
    public class UpdatedGroup : IFlatBufferEx
    {
        ...
        public UpdatedGroup(fb.protocol._internal.response.raw.UpdatedGroup raw)
        {
            ...
            Actor = new CharacterRef(raw.Actor.Value);
            Target = raw.Target != null ? new CharacterRef(raw.Target.Value) : null;
            NewMember = raw.NewMember != null ? new CharacterRef(raw.NewMember.Value) : null;
            DeletedMember = raw.DeletedMember != null ? new CharacterRef(raw.DeletedMember.Value) : null;
            Error = raw.Error;
        }
    ...
    public class GetStoragePending : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.GetStoragePending;
        public uint? User { get; set; } = null;
        public List<fb.protocol._internal.StoragePendingBox> Pending { get; set; } = new List<fb.protocol._internal.StoragePendingBox>();
        public uint Error { get; set; } = 0;

        public GetStoragePending()
        { }

        public GetStoragePending(fb.protocol._internal.response.raw.GetStoragePending raw)
        {
            User = raw.User != null ? (uint?)raw.User.Value.Value : null;
            Pending = Enumerable.Range(0, raw.PendingLength).Select(i => raw.Pending(i)).Select(x => new StoragePendingBox(x.Value)).ToList();
            Error = raw.Error;
        }

        public GetStoragePending(byte[] bytes) : this(fb.protocol._internal.response.raw.GetStoragePending.GetRootAsGetStoragePending(new ByteBuffer(bytes)))
        { }
    ...
    public class GetSystemMails : IFlatBufferEx
    {
        ...
        {
            Mails = Enumerable.Range(0, raw.MailsLength).Select(i => raw.Mails(i)).Select(x => new SystemMail(x.Value)).ToList();
            Error = raw.Error;
        }
    ...
    public class WriteSystemMail : IFlatBufferEx
    {
        ...
        {
            Mail = new SystemMail(raw.Mail.Value);
            Error = raw.Error;
        }
    ...
    public static class FlatBufferProtocolRouter
    {
        public static Type GetProtocolType(FlatBufferProtocolType protocolType)
        {
            return protocolType switch
            {
                ...
                FlatBufferProtocolType.GetStoragePending => typeof(fb.protocol._internal.response.GetStoragePending),
...
namespace fb.protocol.marketplace
{
    ...
    public class MarketplaceItem : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceItem;
        ...
        public MarketplaceItem(fb.protocol.marketplace.raw.MarketplaceItem raw)
        {
            Owner = raw.Owner;
            Model = raw.Model;
            Count = raw.Count;
        ...
        public MarketplaceItem(byte[] bytes) : this(fb.protocol.marketplace.raw.MarketplaceItem.GetRootAsMarketplaceItem(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceItem Deserialize(byte[] bytes)
        {
            return new MarketplaceItem(bytes);
        }
    }
    public class MarketplaceListing : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceListing;
        public ulong Id { get; set; } = 0L;
        public uint SellerId { get; set; } = 0;
        public fb.protocol.marketplace.MarketplaceItem Item { get; set; } = new fb.protocol.marketplace.MarketplaceItem();
        public uint Price { get; set; } = 0;
        public uint ListingFee { get; set; } = 0;
        public uint TransactionFee { get; set; } = 0;
        ...
        public MarketplaceListing(fb.protocol.marketplace.raw.MarketplaceListing raw)
        {
            Id = raw.Id;
            SellerId = raw.SellerId;
            Item = new MarketplaceItem(raw.Item.Value);
            Price = raw.Price;
            ListingFee = raw.ListingFee;
            TransactionFee = raw.TransactionFee;
            ExpireDate = raw.ExpireDate;
            CreatedDate = raw.CreatedDate;
        }

        public MarketplaceListing(byte[] bytes) : this(fb.protocol.marketplace.raw.MarketplaceListing.GetRootAsMarketplaceListing(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceListing Deserialize(byte[] bytes)
        {
            return new MarketplaceListing(bytes);
        }
    }
    public class MarketplaceSearchResult : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceSearchResult;
        public List<fb.protocol.marketplace.MarketplaceListing> Listings { get; set; } = new List<fb.protocol.marketplace.MarketplaceListing>();
        ...
        public MarketplaceSearchResult(fb.protocol.marketplace.raw.MarketplaceSearchResult raw)
        {
            Listings = Enumerable.Range(0, raw.ListingsLength).Select(i => raw.Listings(i)).Select(x => new MarketplaceListing(x.Value)).ToList();
            TotalCount = raw.TotalCount;
            Page = raw.Page;
            PageSize = raw.PageSize;
        }

        public MarketplaceSearchResult(byte[] bytes) : this(fb.protocol.marketplace.raw.MarketplaceSearchResult.GetRootAsMarketplaceSearchResult(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceSearchResult Deserialize(byte[] bytes)
        {
            return new MarketplaceSearchResult(bytes);
        }
    }
    public class PendingTransaction : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.PendingTransaction;
        public ulong Id { get; set; } = 0L;
        public ulong ListingId { get; set; } = 0L;
        public uint BuyerId { get; set; } = 0;
        public uint SellerId { get; set; } = 0;
        public uint ItemModel { get; set; } = 0;
        public ushort ItemCount { get; set; } = 0;
        public uint Price { get; set; } = 0;
        public uint SellerRevenue { get; set; } = 0;
        public string CreatedDate { get; set; } = string.Empty;

        public PendingTransaction()
        { }

        public PendingTransaction(fb.protocol.marketplace.raw.PendingTransaction raw)
        {
            Id = raw.Id;
            ...
            Price = raw.Price;
            SellerRevenue = raw.SellerRevenue;
            CreatedDate = raw.CreatedDate;
        }

        public PendingTransaction(byte[] bytes) : this(fb.protocol.marketplace.raw.PendingTransaction.GetRootAsPendingTransaction(new ByteBuffer(bytes)))
        { }
        ...
        public static PendingTransaction Deserialize(byte[] bytes)
        {
            return new PendingTransaction(bytes);
        }
    }
    public class PendingReturn : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.PendingReturn;
        public ulong Id { get; set; } = 0L;
        public ulong ListingId { get; set; } = 0L;
        public uint SellerId { get; set; } = 0;
        public uint ItemModel { get; set; } = 0;
        public ushort ItemCount { get; set; } = 0;
        public uint? ItemDurability { get; set; } = null;
        public string ItemCustomName { get; set; } = null;
        public string CreatedDate { get; set; } = string.Empty;

        public PendingReturn()
        { }

        public PendingReturn(fb.protocol.marketplace.raw.PendingReturn raw)
        {
            Id = raw.Id;
            ListingId = raw.ListingId;
            SellerId = raw.SellerId;
            ItemModel = raw.ItemModel;
            ItemCount = raw.ItemCount;
            ItemDurability = raw.ItemDurability != null ? (uint?)raw.ItemDurability.Value.Value : null;
            ItemCustomName = raw.ItemCustomName;
            CreatedDate = raw.CreatedDate;
        }

        public PendingReturn(byte[] bytes) : this(fb.protocol.marketplace.raw.PendingReturn.GetRootAsPendingReturn(new ByteBuffer(bytes)))
        { }
        ...
        public static PendingReturn Deserialize(byte[] bytes)
        {
            return new PendingReturn(bytes);
        }
    }
    ...
    public static class FlatBufferProtocolRouter
    {
        public static Type GetProtocolType(FlatBufferProtocolType protocolType)
        {
            return protocolType switch
            {
                FlatBufferProtocolType.MarketplaceItem => typeof(fb.protocol.marketplace.MarketplaceItem),
                FlatBufferProtocolType.MarketplaceListing => typeof(fb.protocol.marketplace.MarketplaceListing),
                FlatBufferProtocolType.MarketplaceSearchResult => typeof(fb.protocol.marketplace.MarketplaceSearchResult),
                FlatBufferProtocolType.PendingTransaction => typeof(fb.protocol.marketplace.PendingTransaction),
                FlatBufferProtocolType.PendingReturn => typeof(fb.protocol.marketplace.PendingReturn),
                _ => throw new ArgumentException(),
            };
        }
    }
...
namespace fb.protocol.marketplace.request
{
    ...
    public class MarketplaceList : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceList;
        ...
        public MarketplaceList(fb.protocol.marketplace.request.raw.MarketplaceList raw)
        {
        ...
        public MarketplaceList(byte[] bytes) : this(fb.protocol.marketplace.request.raw.MarketplaceList.GetRootAsMarketplaceList(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceList Deserialize(byte[] bytes)
        {
            return new MarketplaceList(bytes);
        }
    }
    public class MarketplaceCancel : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceCancel;
        public uint CharacterId { get; set; } = 0;
        public ulong ListingId { get; set; } = 0L;
        ...
        public MarketplaceCancel(fb.protocol.marketplace.request.raw.MarketplaceCancel raw)
        {
            CharacterId = raw.CharacterId;
            ListingId = raw.ListingId;
        }

        public MarketplaceCancel(byte[] bytes) : this(fb.protocol.marketplace.request.raw.MarketplaceCancel.GetRootAsMarketplaceCancel(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceCancel Deserialize(byte[] bytes)
        {
            return new MarketplaceCancel(bytes);
        }
    }
    public class MarketplacePurchase : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplacePurchase;
        public uint BuyerId { get; set; } = 0;
        public ulong ListingId { get; set; } = 0L;
        public string RequestId { get; set; } = string.Empty;
        ...
        public MarketplacePurchase(fb.protocol.marketplace.request.raw.MarketplacePurchase raw)
        {
            BuyerId = raw.BuyerId;
            ListingId = raw.ListingId;
            RequestId = raw.RequestId;
        ...
        public MarketplacePurchase(byte[] bytes) : this(fb.protocol.marketplace.request.raw.MarketplacePurchase.GetRootAsMarketplacePurchase(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplacePurchase Deserialize(byte[] bytes)
        {
            return new MarketplacePurchase(bytes);
        }
    }
    public class MarketplaceSearch : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceSearch;
        ...
        public MarketplaceSearch(fb.protocol.marketplace.request.raw.MarketplaceSearch raw)
        {
            ...
            SortBy = raw.SortBy;
            Page = raw.Page != null ? (uint?)raw.Page.Value.Value : null;
            PageSize = raw.PageSize != null ? (uint?)raw.PageSize.Value.Value : null;
        }

        public MarketplaceSearch(byte[] bytes) : this(fb.protocol.marketplace.request.raw.MarketplaceSearch.GetRootAsMarketplaceSearch(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceSearch Deserialize(byte[] bytes)
        {
            return new MarketplaceSearch(bytes);
        }
    }
    public class MarketplaceCheckListingStatus : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceCheckListingStatus;
        public string RequestId { get; set; } = string.Empty;

        public MarketplaceCheckListingStatus()
        { }

        public MarketplaceCheckListingStatus(fb.protocol.marketplace.request.raw.MarketplaceCheckListingStatus raw)
        {
            RequestId = raw.RequestId;
        }

        public MarketplaceCheckListingStatus(byte[] bytes) : this(fb.protocol.marketplace.request.raw.MarketplaceCheckListingStatus.GetRootAsMarketplaceCheckListingStatus(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceCheckListingStatus Deserialize(byte[] bytes)
        {
            return new MarketplaceCheckListingStatus(bytes);
        }
    }
    public class MarketplaceGetPendingTransactions : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceGetPendingTransactions;
        public uint CharacterId { get; set; } = 0;
        public byte Type { get; set; } = 0;

        public MarketplaceGetPendingTransactions()
        { }

        public MarketplaceGetPendingTransactions(fb.protocol.marketplace.request.raw.MarketplaceGetPendingTransactions raw)
        {
            CharacterId = raw.CharacterId;
            Type = raw.Type;
        }

        public MarketplaceGetPendingTransactions(byte[] bytes) : this(fb.protocol.marketplace.request.raw.MarketplaceGetPendingTransactions.GetRootAsMarketplaceGetPendingTransactions(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceGetPendingTransactions Deserialize(byte[] bytes)
        {
            return new MarketplaceGetPendingTransactions(bytes);
        }
    }
    public class MarketplaceCompletePendingTransaction : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceCompletePendingTransaction;
        public ulong TransactionId { get; set; } = 0L;

        public MarketplaceCompletePendingTransaction()
        { }

        public MarketplaceCompletePendingTransaction(fb.protocol.marketplace.request.raw.MarketplaceCompletePendingTransaction raw)
        {
            TransactionId = raw.TransactionId;
        }

        public MarketplaceCompletePendingTransaction(byte[] bytes) : this(fb.protocol.marketplace.request.raw.MarketplaceCompletePendingTransaction.GetRootAsMarketplaceCompletePendingTransaction(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceCompletePendingTransaction Deserialize(byte[] bytes)
        {
            return new MarketplaceCompletePendingTransaction(bytes);
        }
    }
    public class MarketplaceCompletePendingReturn : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceCompletePendingReturn;
        public ulong ReturnId { get; set; } = 0L;

        public MarketplaceCompletePendingReturn()
        { }

        public MarketplaceCompletePendingReturn(fb.protocol.marketplace.request.raw.MarketplaceCompletePendingReturn raw)
        {
            ReturnId = raw.ReturnId;
        }

        public MarketplaceCompletePendingReturn(byte[] bytes) : this(fb.protocol.marketplace.request.raw.MarketplaceCompletePendingReturn.GetRootAsMarketplaceCompletePendingReturn(new ByteBuffer(bytes)))
        { }
        ...
        public static MarketplaceCompletePendingReturn Deserialize(byte[] bytes)
        {
            return new MarketplaceCompletePendingReturn(bytes);
        }
    }
    ...
    public static class FlatBufferProtocolRouter
    {
        public static Type GetProtocolType(FlatBufferProtocolType protocolType)
        {
            return protocolType switch
            {
                FlatBufferProtocolType.MarketplaceList => typeof(fb.protocol.marketplace.request.MarketplaceList),
                FlatBufferProtocolType.MarketplaceCancel => typeof(fb.protocol.marketplace.request.MarketplaceCancel),
                FlatBufferProtocolType.MarketplacePurchase => typeof(fb.protocol.marketplace.request.MarketplacePurchase),
                FlatBufferProtocolType.MarketplaceSearch => typeof(fb.protocol.marketplace.request.MarketplaceSearch),
                FlatBufferProtocolType.MarketplaceCheckListingStatus => typeof(fb.protocol.marketplace.request.MarketplaceCheckListingStatus),
                FlatBufferProtocolType.MarketplaceGetPendingTransactions => typeof(fb.protocol.marketplace.request.MarketplaceGetPendingTransactions),
                FlatBufferProtocolType.MarketplaceCompletePendingTransaction => typeof(fb.protocol.marketplace.request.MarketplaceCompletePendingTransaction),
                FlatBufferProtocolType.MarketplaceCompletePendingReturn => typeof(fb.protocol.marketplace.request.MarketplaceCompletePendingReturn),
                _ => throw new ArgumentException(),
            };
        }
    }
...
namespace fb.protocol.marketplace.response
{
    ...
    public class MarketplaceList : IFlatBufferEx
    {
        ...
        public MarketplaceList(fb.protocol.marketplace.response.raw.MarketplaceList raw)
        {
            Success = raw.Success;
            ListingId = raw.ListingId;
            ListingFee = raw.ListingFee;
        ...
        public MarketplaceList(byte[] bytes) : this(fb.protocol.marketplace.response.raw.MarketplaceList.GetRootAsMarketplaceList(new ByteBuffer(bytes)))
        { }
    ...
    public class MarketplaceCancel : IFlatBufferEx
    {
        ...
        public MarketplaceCancel(fb.protocol.marketplace.response.raw.MarketplaceCancel raw)
        {
            Success = raw.Success;
            Error = raw.Error;
        }

        public MarketplaceCancel(byte[] bytes) : this(fb.protocol.marketplace.response.raw.MarketplaceCancel.GetRootAsMarketplaceCancel(new ByteBuffer(bytes)))
        { }
    ...
    public class MarketplacePurchase : IFlatBufferEx
    {
        ...
        public MarketplacePurchase(fb.protocol.marketplace.response.raw.MarketplacePurchase raw)
        {
            Success = raw.Success;
            Item = new MarketplaceItem(raw.Item.Value);
            Error = raw.Error;
        ...
        public MarketplacePurchase(byte[] bytes) : this(fb.protocol.marketplace.response.raw.MarketplacePurchase.GetRootAsMarketplacePurchase(new ByteBuffer(bytes)))
        { }
    ...
    public class MarketplaceSearch : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceSearch;
        public bool Success { get; set; } = false;
        public fb.protocol.marketplace.MarketplaceSearchResult Result { get; set; } = new fb.protocol.marketplace.MarketplaceSearchResult();
        public uint Error { get; set; } = 0;

        public MarketplaceSearch()
        { }

        public MarketplaceSearch(fb.protocol.marketplace.response.raw.MarketplaceSearch raw)
        {
            Success = raw.Success;
            Result = new MarketplaceSearchResult(raw.Result.Value);
            Error = raw.Error;
        }

        public MarketplaceSearch(byte[] bytes) : this(fb.protocol.marketplace.response.raw.MarketplaceSearch.GetRootAsMarketplaceSearch(new ByteBuffer(bytes)))
        { }
    ...
    public class MarketplaceCheckListingStatus : IFlatBufferEx
    {
        ...
        public MarketplaceCheckListingStatus(fb.protocol.marketplace.response.raw.MarketplaceCheckListingStatus raw)
        {
            Success = raw.Success;
            ListingId = raw.ListingId;
            ListingFee = raw.ListingFee;
        ...
        public MarketplaceCheckListingStatus(byte[] bytes) : this(fb.protocol.marketplace.response.raw.MarketplaceCheckListingStatus.GetRootAsMarketplaceCheckListingStatus(new ByteBuffer(bytes)))
        { }
    ...
    public class MarketplaceGetPendingTransactions : IFlatBufferEx
    {
        public int ProtocolType => (int)FlatBufferProtocolType.MarketplaceGetPendingTransactions;
        public bool Success { get; set; } = false;
        public List<fb.protocol.marketplace.PendingTransaction> Transactions { get; set; } = new List<fb.protocol.marketplace.PendingTransaction>();
        public List<fb.protocol.marketplace.PendingReturn> Returns { get; set; } = new List<fb.protocol.marketplace.PendingReturn>();
        public uint Error { get; set; } = 0;

        public MarketplaceGetPendingTransactions()
        { }

        public MarketplaceGetPendingTransactions(fb.protocol.marketplace.response.raw.MarketplaceGetPendingTransactions raw)
        {
            Success = raw.Success;
            Transactions = Enumerable.Range(0, raw.TransactionsLength).Select(i => raw.Transactions(i)).Select(x => new PendingTransaction(x.Value)).ToList();
            Returns = Enumerable.Range(0, raw.ReturnsLength).Select(i => raw.Returns(i)).Select(x => new PendingReturn(x.Value)).ToList();
            Error = raw.Error;
        }

        public MarketplaceGetPendingTransactions(byte[] bytes) : this(fb.protocol.marketplace.response.raw.MarketplaceGetPendingTransactions.GetRootAsMarketplaceGetPendingTransactions(new ByteBuffer(bytes)))
        { }
    ...
    public class MarketplaceCompletePendingTransaction : IFlatBufferEx
    {
        ...
        public MarketplaceCompletePendingTransaction(fb.protocol.marketplace.response.raw.MarketplaceCompletePendingTransaction raw)
        {
            Success = raw.Success;
        }

        public MarketplaceCompletePendingTransaction(byte[] bytes) : this(fb.protocol.marketplace.response.raw.MarketplaceCompletePendingTransaction.GetRootAsMarketplaceCompletePendingTransaction(new ByteBuffer(bytes)))
        { }
    ...
    public class MarketplaceCompletePendingReturn : IFlatBufferEx
    {
        ...
        public MarketplaceCompletePendingReturn(fb.protocol.marketplace.response.raw.MarketplaceCompletePendingReturn raw)
        {
            Success = raw.Success;
        }

        public MarketplaceCompletePendingReturn(byte[] bytes) : this(fb.protocol.marketplace.response.raw.MarketplaceCompletePendingReturn.GetRootAsMarketplaceCompletePendingReturn(new ByteBuffer(bytes)))
        { }
    ...
    public static class FlatBufferProtocolRouter
    {
        public static Type GetProtocolType(FlatBufferProtocolType protocolType)
        {
            return protocolType switch
            {
                FlatBufferProtocolType.MarketplaceList => typeof(fb.protocol.marketplace.response.MarketplaceList),
                FlatBufferProtocolType.MarketplaceCancel => typeof(fb.protocol.marketplace.response.MarketplaceCancel),
                FlatBufferProtocolType.MarketplacePurchase => typeof(fb.protocol.marketplace.response.MarketplacePurchase),
                FlatBufferProtocolType.MarketplaceSearch => typeof(fb.protocol.marketplace.response.MarketplaceSearch),
                FlatBufferProtocolType.MarketplaceCheckListingStatus => typeof(fb.protocol.marketplace.response.MarketplaceCheckListingStatus),
                FlatBufferProtocolType.MarketplaceGetPendingTransactions => typeof(fb.protocol.marketplace.response.MarketplaceGetPendingTransactions),
                FlatBufferProtocolType.MarketplaceCompletePendingTransaction => typeof(fb.protocol.marketplace.response.MarketplaceCompletePendingTransaction),
                FlatBufferProtocolType.MarketplaceCompletePendingReturn => typeof(fb.protocol.marketplace.response.MarketplaceCompletePendingReturn),
                _ => throw new ArgumentException(),
            };
        }
    }
