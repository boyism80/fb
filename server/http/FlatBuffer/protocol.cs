...
namespace fb.protocol._internal
{
    ...
    public class SavePayload : IFlatBufferEx
    {
        ...
        public SavePayload(fb.protocol._internal.raw.SavePayload raw)
        {
            ...
            ReceivedSystemMails = Enumerable.Range(0, raw.ReceivedSystemMailsLength).Select(i => raw.ReceivedSystemMails(i)).Select(x => new fb.protocol._internal.SystemMailUser(x.Value)).ToList();
