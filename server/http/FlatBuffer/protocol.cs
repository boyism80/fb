...
namespace fb.protocol._internal
{
    ...
    public class SavePayload : IFlatBufferEx
    {
        ...
        public SavePayload(fb.protocol._internal.raw.SavePayload raw)
        {
            ...
            StorageRewardMarks = Enumerable.Range(0, raw.StorageRewardMarksLength).Select(i => raw.StorageRewardMarks(i)).Select(x => new fb.protocol._internal.StorageRewardMark(x.Value)).ToList();
        }
...
namespace fb.protocol._internal.response
{
    ...
    public class Init : IFlatBufferEx
    {
        ...
        public Init(fb.protocol._internal.response.raw.Init raw)
        {
            ...
            StorageBoxes = Enumerable.Range(0, raw.StorageBoxesLength).Select(i => raw.StorageBoxes(i)).Select(x => new fb.protocol._internal.StorageBox(x.Value)).ToList();
            StorageRewardMarks = Enumerable.Range(0, raw.StorageRewardMarksLength).Select(i => raw.StorageRewardMarks(i)).Select(x => new fb.protocol._internal.StorageRewardMark(x.Value)).ToList();
            StoragePending = Enumerable.Range(0, raw.StoragePendingLength).Select(i => raw.StoragePending(i)).Select(x => new fb.protocol._internal.StoragePendingBox(x.Value)).ToList();
            Mail = raw.Mail;
        }
    ...
    public class GetStoragePending : IFlatBufferEx
    {
        ...
        {
            User = raw.User != null ? (uint?)raw.User.Value.Value : null;
            Pending = Enumerable.Range(0, raw.PendingLength).Select(i => raw.Pending(i)).Select(x => new fb.protocol._internal.StoragePendingBox(x.Value)).ToList();
            Error = raw.Error;
        }
