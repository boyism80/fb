...
private:
    static fb::game::bulletin::article to_article(const fb::protocol::internal::ArticleSummary& summary,
                                                  uint16_t                                      section);
    static fb::game::bulletin::article to_article(const fb::protocol::internal::Article& article,
                                                  uint16_t                               section,
                                                  bool                                   next);
