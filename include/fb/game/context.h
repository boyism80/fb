...
/**
 * @brief      The main game server context that manages all game world operations.
 *
 ...
 *             groups, clans, and all game mechanics. The context serves as the central coordinator
...
public:
    /**
     * @brief      Constructs a new game server context with network and world initialization.
     *
     *             Initializes the game server with the specified I/O context and port.
     ...
     *
     *             The game context cannot be copied as it manages unique resources
     *             like network connections, database connections, and game state.
     */
    context(const context&) = delete;

    /**
     * @brief      Destroys the game context and cleans up all resources.
     *
...
protected:
    ...
    /**
     * @brief      Gets the service type for this game context.
     *
...
public:
     ...
     * @param[in]  id    The thread identifier for this processing context.
     *
