...
public:
    ...
    void                  broadcast(std::string_view message, MESSAGE_TYPE type, bool respect_roar = false);
    async::task<void>     broadcast(std::string_view message,
                                    MESSAGE_TYPE     type,
                                    BROADCAST_TYPE   broadcast_type,
                                    bool             respect_roar = false);
