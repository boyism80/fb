...
class front_info : public fb::handler::protocol<fb::game::server, game_reqs::front_info>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::front_info& request) override;
};
