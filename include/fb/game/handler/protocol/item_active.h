...
class item_active : public fb::handler::protocol<fb::game::server, game_reqs::item_active>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::item_active& request) override final;
};
