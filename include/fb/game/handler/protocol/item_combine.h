...
class item_combine : public fb::handler::protocol<fb::game::server, game_reqs::item_combine>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::item_combine& request) override;
};
