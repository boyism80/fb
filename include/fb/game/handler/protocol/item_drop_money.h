...
class item_drop_money : public fb::handler::protocol<fb::game::server, game_reqs::item_drop_money>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::item_drop_money& request) override;
};
