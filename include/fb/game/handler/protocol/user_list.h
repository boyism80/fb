...
class user_list : public fb::handler::protocol<fb::game::server, game_reqs::user_list>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::user_list& request) override;
};
