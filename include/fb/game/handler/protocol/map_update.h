...
class map_update : public fb::handler::protocol<fb::game::server, game_reqs::map_update<V>>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::map_update<V>& request) override;
};
