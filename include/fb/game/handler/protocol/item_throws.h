...
class item_throws : public fb::handler::protocol<fb::game::server, game_reqs::item_throws<V>>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::item_throws<V>& request) override;
};
