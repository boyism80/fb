...
class item_info : public fb::handler::protocol<fb::game::server, game_reqs::item_info<V>>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::item_info<V>& request) override;
};
