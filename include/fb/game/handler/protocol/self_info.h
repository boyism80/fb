...
class self_info : public fb::handler::protocol<fb::game::server, game_reqs::self_info>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::self_info& request) override;
};
