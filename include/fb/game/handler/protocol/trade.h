...
class trade : public fb::handler::protocol<fb::game::server, game_reqs::trade>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::trade& request) override;
};
