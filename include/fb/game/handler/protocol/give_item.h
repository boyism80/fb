...
class give_item : public fb::handler::protocol<fb::game::server, game_reqs::give_item>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::give_item& request) override;
};
