...
class attack : public fb::handler::protocol<fb::game::server, game_reqs::attack<V>>
{
public:
    ...
    async::task<bool> handle(fb::socket<character>& session, game_reqs::attack<V>& request) override;
};
