#ifndef FB_GAME_HANDLER_NPC_INTERACTION_DEPOSIT_MONEY_H
#define FB_GAME_HANDLER_NPC_INTERACTION_DEPOSIT_MONEY_H
...
/**
 * @brief   Handles NPC money deposit interactions.
 *
 *          Processes player messages for money deposit with NPCs.
 */
class deposit_money : public fb::game::npc_interaction_handler
{
public:
    /**
     * @brief   Constructs a deposit_money handler.
     *
     * @param[in]  server  Reference to the game server
     */
    deposit_money(server_type& server) : npc_interaction_handler(server) {}

    /**
     * @brief   Checks if the message matches the deposit_money pattern.
     *
    ...
    /**
     * @brief   Handles money deposit interaction.
     *
...
#endif // FB_GAME_HANDLER_NPC_INTERACTION_DEPOSIT_MONEY_H