...
public:
    ...
    void                            on_dialog_buy(character& me, const fb::model::object& obj, std::string_view message, const fb::game::dialog::buy_entries& entries, uint32_t seq = 0xFFFFFFFD, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog_buy(character& me, const fb::game::object& obj, std::string_view message, const fb::game::dialog::buy_entries& entries, uint32_t seq = 0xFFFFFFFD, uint16_t pursuit = 0xFFFF) override final;
