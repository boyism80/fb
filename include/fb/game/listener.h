...
public:
    ...
    void                            on_dialog(character& me, const fb::game::object& obj, std::optional<std::string> message, const std::vector<std::string>& menus, bool button_prev, uint32_t seq = 0xFFFFFFFD) override final;
    void                            on_dialog(character& me, std::unique_ptr<fb::game::appearance>&& appearance_ptr, std::optional<std::string> message, const std::vector<std::string>& menus, bool button_prev, uint32_t seq = 0xFFFFFFFD) override final;
    ...
    void                            on_dialog(character& me, const fb::model::object& obj, std::string_view message, uint32_t seq = 0xFFFFFFFD, std::optional<std::string> ext = std::nullopt, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog(character& me, const fb::game::object& obj, std::string_view message, uint32_t seq = 0xFFFFFFFD, std::optional<std::string> ext = std::nullopt, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog(character& me, const fb::model::object& obj, std::optional<std::string> message, std::string_view top, std::string_view bottom, int maxlen = 0xFF, bool prev = false, bool password = false, uint32_t seq = 0xFFFFFFFD) override final;
    void                            on_dialog(character& me, const fb::game::object& obj, std::optional<std::string> message, std::string_view top, std::string_view bottom, int maxlen = 0xFF, bool prev = false, bool password = false, uint32_t seq = 0xFFFFFFFD) override final;
    void                            on_dialog_pursuit(character& me, const fb::model::object& obj, std::string_view message, const std::vector<std::string>& options, uint32_t seq = 0xFFFFFFFD, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog_pursuit(character& me, const fb::game::object& obj, std::string_view message, const std::vector<std::string>& options, uint32_t seq = 0xFFFFFFFD, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog_spell(character& me, const fb::model::object& obj, std::string_view message, uint32_t seq = 0xFFFFFFFD, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog_spell(character& me, const fb::game::object& obj, std::string_view message, uint32_t seq = 0xFFFFFFFD, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog_dual_field(character& me, const fb::model::object& obj, std::string_view message, const std::vector<std::pair<std::string, std::string>>& pairs, uint32_t seq = 0xFFFFFFFD, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog_dual_field(character& me, const fb::game::object& obj, std::string_view message, const std::vector<std::pair<std::string, std::string>>& pairs, uint32_t seq = 0xFFFFFFFD, uint16_t pursuit = 0xFFFF) override final;
    void                            on_dialog_email(character& me, const fb::model::object& obj, std::string_view message, std::string_view str1, std::string_view str2, bool button_prev = false, bool button_next = false, uint32_t seq = 0xFFFFFFFD) override final;
