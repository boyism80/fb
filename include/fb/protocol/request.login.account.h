...
public:
    ...
    { }
#else
    create(const std::string& id, const std::string& pw) : fb::protocol::base::header(0x02),
        id(id), pw(pw)
    { }
#endif
...
public:
    ...
    { }
#else
    change_pw(const std::string& name, const std::string& pw, const std::string& new_pw, uint32_t birthday) : fb::protocol::base::header(0x26),
        name(name), pw(pw), new_pw(new_pw), birthday(birthday)
    { }
#endif
