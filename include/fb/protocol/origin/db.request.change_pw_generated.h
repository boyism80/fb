...
#ifndef FLATBUFFERS_GENERATED_DBREQUESTCHANGEPW_FB_PROTOCOL_DB_REQUEST_ORIGIN_H_
#define FLATBUFFERS_GENERATED_DBREQUESTCHANGEPW_FB_PROTOCOL_DB_REQUEST_ORIGIN_H_
...
inline ::flatbuffers::Offset<ChangePw> CreateChangePwDirect(
  ...
  return fb::protocol::db::request::origin::CreateChangePw(
      _fbb,
      uid,
      before__,
      after__,
...
inline const fb::protocol::db::request::origin::ChangePw *GetChangePw(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::db::request::origin::ChangePw>(buf);
}

inline const fb::protocol::db::request::origin::ChangePw *GetSizePrefixedChangePw(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::db::request::origin::ChangePw>(buf);
}

inline bool VerifyChangePwBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::db::request::origin::ChangePw>(nullptr);
}

inline bool VerifySizePrefixedChangePwBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::db::request::origin::ChangePw>(nullptr);
}

inline void FinishChangePwBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::db::request::origin::ChangePw> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_DBREQUESTCHANGEPW_FB_PROTOCOL_DB_REQUEST_ORIGIN_H_
