...
#ifndef FLATBUFFERS_GENERATED_DBRESPONSEACCOUNT_FB_PROTOCOL_DB_RESPONSE_ORIGIN_H_
#define FLATBUFFERS_GENERATED_DBRESPONSEACCOUNT_FB_PROTOCOL_DB_RESPONSE_ORIGIN_H_
...
inline const fb::protocol::db::response::origin::Account *GetAccount(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::db::response::origin::Account>(buf);
}

inline const fb::protocol::db::response::origin::Account *GetSizePrefixedAccount(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::db::response::origin::Account>(buf);
}

inline bool VerifyAccountBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::db::response::origin::Account>(nullptr);
}

inline bool VerifySizePrefixedAccountBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::db::response::origin::Account>(nullptr);
}

inline void FinishAccountBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::db::response::origin::Account> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_DBRESPONSEACCOUNT_FB_PROTOCOL_DB_RESPONSE_ORIGIN_H_
