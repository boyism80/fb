...
public:
    subscribe() :
        fb::protocol::internal::header(SUBSCRIBE)
    { }
...
public:
    void serialize(fb::ostream& out_stream) const
    {
        ...
        out_stream.writestr_u8(this->name, false).write_u8(this->service).write_u8(this->group);
    }
...
public:
    login() :
        fb::protocol::internal::header(LOGIN)
    { }
...
public:
    ...
    {
        fb::protocol::internal::header::serialize(out_stream);
        out_stream.writestr_u8(this->name, false).write_u16(this->map);
    }
...
public:
    whisper() :
        fb::protocol::internal::header(WHISPER)
    { }
...
public:
    ...
    {
        fb::protocol::internal::header::serialize(out_stream);
        out_stream.writestr_u8(this->from, false).writestr_u8(this->to, false).writestr_u8(this->message, false);
    }
