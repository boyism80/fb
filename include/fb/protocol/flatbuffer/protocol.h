...
public:
    ...
    StoragePendingBox(unsigned long id, const std::optional<uint32_t>& user, const std::string& title, const std::string& message, const std::string& attachments, const std::optional<std::string>& expired_date)
    ...
    StoragePendingBox(const fb::protocol::internal::raw::StoragePendingBox& raw)
        : id(raw.id()), user(raw.user() != nullptr ? raw.user()->value() : std::optional<uint32_t>()), title(flatbuffers::option::decode(raw.title()->c_str())), message(flatbuffers::option::decode(raw.message()->c_str())), attachments(flatbuffers::option::decode(raw.attachments()->c_str())), expired_date(raw.expired_date() != nullptr ? flatbuffers::option::decode(raw.expired_date()->c_str()) : std::optional<std::string>())
    { }
...
public:
    ...
    StorageRewardMark(uint32_t user, unsigned long pending_id, const std::optional<std::string>& expired_date)
    ...
    StorageRewardMark(const fb::protocol::internal::raw::StorageRewardMark& raw)
        : user(raw.user()), pending_id(raw.pending_id()), expired_date(raw.expired_date() != nullptr ? flatbuffers::option::decode(raw.expired_date()->c_str()) : std::optional<std::string>())
    { }
...
flatbuffers::Offset<fb::protocol::internal::raw::StorageRewardMark> build<fb::protocol::internal::StorageRewardMark>(FlatBufferBuilder& builder, const fb::protocol::internal::StorageRewardMark& value)
{
    return fb::protocol::internal::raw::CreateStorageRewardMark(builder,
            flatbuffers::build<uint32_t>(builder, value.user),
            flatbuffers::build<unsigned long>(builder, value.pending_id),
            flatbuffers::build<std::optional<std::string>>(builder, value.expired_date));
}
template <>
flatbuffers::Offset<fb::protocol::internal::request::raw::Shutdown> build<fb::protocol::internal::request::Shutdown>(FlatBufferBuilder& builder, const fb::protocol::internal::request::Shutdown& value)
