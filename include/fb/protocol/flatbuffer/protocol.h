...
public:
    ...
    SystemMail(const SystemMail& x)
        : id(x.id), title(x.title), contents(x.contents), expire_date(x.expire_date), created_date(x.created_date)
    { }

    SystemMail(uint32_t id, const std::string& title, const std::string& contents, const std::optional<std::string>& expire_date, const std::string& created_date)
        : id(id), title(title), contents(contents), expire_date(expire_date), created_date(created_date)
    { }

    SystemMail(const fb::protocol::internal::raw::SystemMail& raw)
        : id(raw.id()), title(flatbuffers::option::decode(raw.title()->c_str())), contents(flatbuffers::option::decode(raw.contents()->c_str())), expire_date(raw.expire_date() != nullptr ? flatbuffers::option::decode(raw.expire_date()->c_str()) : std::optional<std::string>()), created_date(flatbuffers::option::decode(raw.created_date()->c_str()))
    { }
...
public:
    ...
    Save(const Save& x)
        : character(x.character), items(x.items), spells(x.spells), achievements(x.achievements), quests(x.quests), received_system_mails(x.received_system_mails)
    { }
...
public:
    ...
    WriteMail(const std::string& sender, const std::string& user, const std::string& title, const std::string& contents, uint32_t host)
    ...
    WriteMail(const fb::protocol::internal::request::raw::WriteMail& raw)
        : sender(flatbuffers::option::decode(raw.sender()->c_str())), user(flatbuffers::option::decode(raw.user()->c_str())), title(flatbuffers::option::decode(raw.title()->c_str())), contents(flatbuffers::option::decode(raw.contents()->c_str())), host(raw.host())
    { }
...
public:
    ...
    WriteSystemMail(const WriteSystemMail& x)
        : title(x.title), contents(x.contents), expire_date(x.expire_date)
    { }

    WriteSystemMail(const std::string& title, const std::string& contents, const std::optional<std::string>& expire_date)
        : title(title), contents(contents), expire_date(expire_date)
    { }

    WriteSystemMail(const fb::protocol::internal::request::raw::WriteSystemMail& raw)
        : title(flatbuffers::option::decode(raw.title()->c_str())), contents(flatbuffers::option::decode(raw.contents()->c_str())), expire_date(raw.expire_date() != nullptr ? flatbuffers::option::decode(raw.expire_date()->c_str()) : std::optional<std::string>())
    { }
