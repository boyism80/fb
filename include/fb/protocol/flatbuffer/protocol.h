...
public:
    ...
    Character(const Character& x)
        : id(x.id), name(x.name), pw(x.pw), birth(x.birth), role(x.role), look(x.look), color(x.color), gender(x.gender), nation(x.nation), creature(x.creature), map(x.map), position(x.position), direction(x.direction), state(x.state), class_type(x.class_type), promotion(x.promotion), level(x.level), exp(x.exp), money(x.money), deposited_money(x.deposited_money), disguise(x.disguise), hp(x.hp), base_hp(x.base_hp), additional_hp(x.additional_hp), mp(x.mp), base_mp(x.base_mp), additional_mp(x.additional_mp), weapon_color(x.weapon_color), helmet_color(x.helmet_color), armor_color(x.armor_color), shield_color(x.shield_color), ring_left_color(x.ring_left_color), ring_right_color(x.ring_right_color), aux_top_color(x.aux_top_color), aux_bot_color(x.aux_bot_color), buffs(x.buffs), title(x.title), pending_listings(x.pending_listings), created_date(x.created_date), updated_date(x.updated_date), super_hide(x.super_hide)
    { }
