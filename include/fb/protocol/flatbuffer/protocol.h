 ...
 *          Generation timestamp: 24 Apr 2026
 */
...
public:
    ...
    SavePayload(const SavePayload& x)
        : character(x.character), marriage(x.marriage), items(x.items), spells(x.spells), achievements(x.achievements), quests(x.quests), received_system_mails(x.received_system_mails), storage_boxes(x.storage_boxes), storage_reward_marks(x.storage_reward_marks)
    { }
    ...
    SavePayload(const fb::protocol::internal::Character& character, const fb::protocol::internal::Marriage& marriage, std::vector<fb::protocol::internal::Item> items, std::vector<fb::protocol::internal::Spell> spells, std::vector<fb::protocol::internal::Achievement> achievements, std::vector<fb::protocol::internal::Quest> quests, std::vector<fb::protocol::internal::SystemMailUser> received_system_mails, std::vector<fb::protocol::internal::StorageBox> storage_boxes, std::vector<fb::protocol::internal::StorageRewardMark> storage_reward_marks)
        : character(character), marriage(marriage), items(items), spells(spells), achievements(achievements), quests(quests), received_system_mails(received_system_mails), storage_boxes(storage_boxes), storage_reward_marks(storage_reward_marks)
    { }
...
public:
    ...
    Init(const Init& x)
        : character(x.character), marriage(x.marriage), group(x.group), clan(x.clan), items(x.items), spells(x.spells), option(x.option), achievements(x.achievements), quests(x.quests), received_system_mails(x.received_system_mails), storage_boxes(x.storage_boxes), storage_reward_marks(x.storage_reward_marks), storage_pending(x.storage_pending), mail(x.mail)
    { }
    ...
    Init(const fb::protocol::internal::Character& character, const fb::protocol::internal::Marriage& marriage, const std::optional<uint32_t>& group, const std::optional<uint32_t>& clan, std::vector<fb::protocol::internal::Item> items, std::vector<fb::protocol::internal::Spell> spells, const fb::protocol::internal::Option& option, std::vector<fb::protocol::internal::Achievement> achievements, std::vector<fb::protocol::internal::Quest> quests, std::vector<fb::protocol::internal::SystemMailUser> received_system_mails, std::vector<fb::protocol::internal::StorageBox> storage_boxes, std::vector<fb::protocol::internal::StorageRewardMark> storage_reward_marks, std::vector<fb::protocol::internal::StoragePendingBox> storage_pending, uint32_t mail)
        : character(character), marriage(marriage), group(group), clan(clan), items(items), spells(spells), option(option), achievements(achievements), quests(quests), received_system_mails(received_system_mails), storage_boxes(storage_boxes), storage_reward_marks(storage_reward_marks), storage_pending(storage_pending), mail(mail)
    { }
