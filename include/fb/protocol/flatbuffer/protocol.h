...
public:
    ...
    SavePayload(const SavePayload& x)
        : character(x.character), marriage(x.marriage), items(x.items), spells(x.spells), achievements(x.achievements), quests(x.quests), storage_boxes(x.storage_boxes), marketplace_pendings(x.marketplace_pendings)
    { }
    ...
    SavePayload(const fb::protocol::internal::Character& character, const fb::protocol::internal::Marriage& marriage, std::vector<fb::protocol::internal::Item> items, std::vector<fb::protocol::internal::Spell> spells, std::vector<fb::protocol::internal::Achievement> achievements, std::vector<fb::protocol::internal::Quest> quests, std::vector<fb::protocol::internal::StorageBox> storage_boxes, std::vector<fb::protocol::internal::MarketplacePending> marketplace_pendings)
        : character(character), marriage(marriage), items(items), spells(spells), achievements(achievements), quests(quests), storage_boxes(storage_boxes), marketplace_pendings(marketplace_pendings)
    { }
...
public:
    ...
    Init(const Init& x)
        : character(x.character), marriage(x.marriage), group(x.group), clan(x.clan), items(x.items), spells(x.spells), option(x.option), achievements(x.achievements), quests(x.quests), storage_boxes(x.storage_boxes), marketplace_pendings(x.marketplace_pendings), mail(x.mail)
    { }
    ...
    Init(const fb::protocol::internal::Character& character, const fb::protocol::internal::Marriage& marriage, const std::optional<uint32_t>& group, const std::optional<uint32_t>& clan, std::vector<fb::protocol::internal::Item> items, std::vector<fb::protocol::internal::Spell> spells, const fb::protocol::internal::Option& option, std::vector<fb::protocol::internal::Achievement> achievements, std::vector<fb::protocol::internal::Quest> quests, std::vector<fb::protocol::internal::StorageBox> storage_boxes, std::vector<fb::protocol::internal::MarketplacePending> marketplace_pendings, uint32_t mail)
        : character(character), marriage(marriage), group(group), clan(clan), items(items), spells(spells), option(option), achievements(achievements), quests(quests), storage_boxes(storage_boxes), marketplace_pendings(marketplace_pendings), mail(mail)
    { }
