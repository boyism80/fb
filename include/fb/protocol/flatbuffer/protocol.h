 ...
 *          Generation timestamp: 18 May 2026
 */
...
public:
    ...
    StorageBox(uint32_t user, uint32_t id, std::string_view title, std::string_view message, std::string_view attachments, bool received, const std::optional<std::string>& expired_date)
        : user(user), id(id), title(std::string(title)), message(std::string(message)), attachments(std::string(attachments)), received(received), expired_date(expired_date)
    { }
...
public:
    ...
    StoragePendingBox(std::string_view id, const std::optional<uint32_t>& user, std::string_view title, std::string_view message, std::string_view attachments, const std::optional<std::string>& expired_date)
        : id(std::string(id)), user(user), title(std::string(title)), message(std::string(message)), attachments(std::string(attachments)), expired_date(expired_date)
    { }
...
public:
    ...
    StorageRewardMark(uint32_t user, std::string_view pending_id, const std::optional<std::string>& expired_date)
        : user(user), pending_id(std::string(pending_id)), expired_date(expired_date)
    { }
...
public:
    ...
    SavePayload(const SavePayload& x)
        : character(x.character), marriage(x.marriage), items(x.items), spells(x.spells), achievements(x.achievements), quests(x.quests), storage_boxes(x.storage_boxes), storage_reward_marks(x.storage_reward_marks)
    { }
    ...
    SavePayload(const fb::protocol::internal::Character& character, const fb::protocol::internal::Marriage& marriage, std::vector<fb::protocol::internal::Item> items, std::vector<fb::protocol::internal::Spell> spells, std::vector<fb::protocol::internal::Achievement> achievements, std::vector<fb::protocol::internal::Quest> quests, std::vector<fb::protocol::internal::StorageBox> storage_boxes, std::vector<fb::protocol::internal::StorageRewardMark> storage_reward_marks)
        : character(character), marriage(marriage), items(items), spells(spells), achievements(achievements), quests(quests), storage_boxes(storage_boxes), storage_reward_marks(storage_reward_marks)
    { }
...
public:
    ...
    GetStoragePending(const GetStoragePending& x)
        : world(x.world), user(x.user)
    { }

    GetStoragePending(uint32_t world, uint32_t user)
        : world(world), user(user)
    { }

    GetStoragePending(const fb::protocol::internal::request::raw::GetStoragePending& raw)
        : world(raw.world()), user(raw.user())
    { }
...
public:
    ...
    Init(const Init& x)
        : character(x.character), marriage(x.marriage), group(x.group), clan(x.clan), items(x.items), spells(x.spells), option(x.option), achievements(x.achievements), quests(x.quests), storage_boxes(x.storage_boxes), storage_reward_marks(x.storage_reward_marks), storage_pending(x.storage_pending), mail(x.mail)
    { }
    ...
    Init(const fb::protocol::internal::Character& character, const fb::protocol::internal::Marriage& marriage, const std::optional<uint32_t>& group, const std::optional<uint32_t>& clan, std::vector<fb::protocol::internal::Item> items, std::vector<fb::protocol::internal::Spell> spells, const fb::protocol::internal::Option& option, std::vector<fb::protocol::internal::Achievement> achievements, std::vector<fb::protocol::internal::Quest> quests, std::vector<fb::protocol::internal::StorageBox> storage_boxes, std::vector<fb::protocol::internal::StorageRewardMark> storage_reward_marks, std::vector<fb::protocol::internal::StoragePendingBox> storage_pending, uint32_t mail)
        : character(character), marriage(marriage), group(group), clan(clan), items(items), spells(spells), option(option), achievements(achievements), quests(quests), storage_boxes(storage_boxes), storage_reward_marks(storage_reward_marks), storage_pending(storage_pending), mail(mail)
    { }
