 ...
 *          Generation timestamp: 13 Dec 2025
 */
...
#include <fb/protocol/flatbuffer/raw/fb.protocol.marketplace.request.allocatelistingid_generated.h>
...
#include <fb/protocol/flatbuffer/raw/fb.protocol.marketplace.request.checklistingstatus_generated.h>
#include <fb/protocol/flatbuffer/raw/fb.protocol.marketplace.request.getlistings_generated.h>
#include <fb/protocol/flatbuffer/raw/fb.protocol.marketplace.response.allocatelistingid_generated.h>
...
#include <fb/protocol/flatbuffer/raw/fb.protocol.marketplace.response.checklistingstatus_generated.h>
...
{
    class AllocateListingId;
    class List;
    class Cancel;
    class Purchase;
    class Search;
    class CheckListingStatus;
    class GetListings;
...
template <> struct FlatBufferOffset<fb::protocol::marketplace::request::AllocateListingId> { typedef flatbuffers::Offset<fb::protocol::marketplace::request::raw::AllocateListingId> type; };
...
template <> struct FlatBufferOffset<fb::protocol::marketplace::request::CheckListingStatus> { typedef flatbuffers::Offset<fb::protocol::marketplace::request::raw::CheckListingStatus> type; };
...
template <> struct FlatBufferOffset<fb::protocol::marketplace::response::AllocateListingId> { typedef flatbuffers::Offset<fb::protocol::marketplace::response::raw::AllocateListingId> type; };
...
template <> struct FlatBufferOffset<fb::protocol::marketplace::response::CheckListingStatus> { typedef flatbuffers::Offset<fb::protocol::marketplace::response::raw::CheckListingStatus> type; };
...
template <>
flatbuffers::Offset<fb::protocol::marketplace::request::raw::AllocateListingId> build<fb::protocol::marketplace::request::AllocateListingId>(FlatBufferBuilder& builder, const fb::protocol::marketplace::request::AllocateListingId& value);
template <>
...
template <>
flatbuffers::Offset<fb::protocol::marketplace::request::raw::CheckListingStatus> build<fb::protocol::marketplace::request::CheckListingStatus>(FlatBufferBuilder& builder, const fb::protocol::marketplace::request::CheckListingStatus& value);
template <>
...
template <>
flatbuffers::Offset<fb::protocol::marketplace::response::raw::AllocateListingId> build<fb::protocol::marketplace::response::AllocateListingId>(FlatBufferBuilder& builder, const fb::protocol::marketplace::response::AllocateListingId& value);
template <>
...
template <>
flatbuffers::Offset<fb::protocol::marketplace::response::raw::CheckListingStatus> build<fb::protocol::marketplace::response::CheckListingStatus>(FlatBufferBuilder& builder, const fb::protocol::marketplace::response::CheckListingStatus& value);
template <>
...
public:
    ...
    Listing(const Listing& x)
        : id(x.id), seller_id(x.seller_id), buyer_id(x.buyer_id), item(x.item), price(x.price), transaction_fee(x.transaction_fee), state(x.state), expire_date(x.expire_date), created_date(x.created_date)
    { }

    Listing(const std::string& id, uint32_t seller_id, uint32_t buyer_id, const fb::protocol::marketplace::Item& item, uint32_t price, uint32_t transaction_fee, fb::protocol::marketplace::ListingState state, const std::string& expire_date, const std::string& created_date)
        : id(id), seller_id(seller_id), buyer_id(buyer_id), item(item), price(price), transaction_fee(transaction_fee), state(state), expire_date(expire_date), created_date(created_date)
    { }

    Listing(const fb::protocol::marketplace::raw::Listing& raw)
        : id(flatbuffers::option::decode(raw.id()->c_str())), seller_id(raw.seller_id()), buyer_id(raw.buyer_id()), item(*raw.item()), price(raw.price()), transaction_fee(raw.transaction_fee()), state((fb::protocol::marketplace::ListingState)raw.state()), expire_date(flatbuffers::option::decode(raw.expire_date()->c_str())), created_date(flatbuffers::option::decode(raw.created_date()->c_str()))
    { }
...
{
public:
    static inline fb::protocol::marketplace::request::FlatBufferProtocolType FlatBufferProtocolType = fb::protocol::marketplace::request::FlatBufferProtocolType::AllocateListingId;

public:
    uint32_t character_id = 0;

public:
    AllocateListingId() = default;

    AllocateListingId(const AllocateListingId& x)
        : character_id(x.character_id)
    { }

    AllocateListingId(uint32_t character_id)
        : character_id(character_id)
    { }

    AllocateListingId(const fb::protocol::marketplace::request::raw::AllocateListingId& raw)
...
public:
    ...
    {
        auto builder = flatbuffers::FlatBufferBuilder();
        builder.Finish(build<fb::protocol::marketplace::request::AllocateListingId>(builder, *this));
        auto buffer = std::vector<uint8_t>(builder.GetSize());
        std::memcpy(buffer.data(), builder.GetBufferPointer(), builder.GetSize());
        return buffer;
    }

    static AllocateListingId Deserialize(const uint8_t* bytes)
    {
        auto raw = fb::protocol::marketplace::request::raw::GetAllocateListingId(bytes);
        return AllocateListingId(*raw);
    }
};
class List
{
...
public:
    ...
    Purchase(const Purchase& x)
        : buyer_id(x.buyer_id), listing_id(x.listing_id)
    { }

    Purchase(uint32_t buyer_id, const std::string& listing_id)
        : buyer_id(buyer_id), listing_id(listing_id)
    { }

    Purchase(const fb::protocol::marketplace::request::raw::Purchase& raw)
        : buyer_id(raw.buyer_id()), listing_id(flatbuffers::option::decode(raw.listing_id()->c_str()))
    { }
...
{
public:
    static inline fb::protocol::marketplace::request::FlatBufferProtocolType FlatBufferProtocolType = fb::protocol::marketplace::request::FlatBufferProtocolType::CheckListingStatus;

public:
    std::string listing_id;

public:
    CheckListingStatus() = default;

    CheckListingStatus(const CheckListingStatus& x)
        : listing_id(x.listing_id)
    { }

    CheckListingStatus(const std::string& listing_id)
        : listing_id(listing_id)
    { }

    CheckListingStatus(const fb::protocol::marketplace::request::raw::CheckListingStatus& raw)
        : listing_id(flatbuffers::option::decode(raw.listing_id()->c_str()))
    { }
...
public:
    ...
    {
        auto builder = flatbuffers::FlatBufferBuilder();
        builder.Finish(build<fb::protocol::marketplace::request::CheckListingStatus>(builder, *this));
        auto buffer = std::vector<uint8_t>(builder.GetSize());
        std::memcpy(buffer.data(), builder.GetBufferPointer(), builder.GetSize());
        return buffer;
    }

    static CheckListingStatus Deserialize(const uint8_t* bytes)
    {
        auto raw = fb::protocol::marketplace::request::raw::GetCheckListingStatus(bytes);
        return CheckListingStatus(*raw);
    }
};
class GetListings
{
...
public:
    ...
    GetListings(const GetListings& x)
        : listing_ids(x.listing_ids)
    { }

    GetListings(std::vector<std::string> listing_ids)
        : listing_ids(listing_ids)
    { }

    GetListings(const fb::protocol::marketplace::request::raw::GetListings& raw)
        : listing_ids(unpack<std::string>(raw.listing_ids()))
    { }
...
{
public:
    static inline fb::protocol::marketplace::response::FlatBufferProtocolType FlatBufferProtocolType = fb::protocol::marketplace::response::FlatBufferProtocolType::AllocateListingId;
...
public:
    ...
    AllocateListingId(const std::string& listing_id, uint32_t error)
        : listing_id(listing_id), error(error)
    { }

    AllocateListingId(const fb::protocol::marketplace::response::raw::AllocateListingId& raw)
...
public:
    ...
    {
        auto builder = flatbuffers::FlatBufferBuilder();
        builder.Finish(build<fb::protocol::marketplace::response::AllocateListingId>(builder, *this));
        auto buffer = std::vector<uint8_t>(builder.GetSize());
        std::memcpy(buffer.data(), builder.GetBufferPointer(), builder.GetSize());
        return buffer;
    }
    ...
    static AllocateListingId Deserialize(const uint8_t* bytes)
    {
        auto raw = fb::protocol::marketplace::response::raw::GetAllocateListingId(bytes);
        return AllocateListingId(*raw);
    }
};
class List
...
public:
    ...
    Purchase(const Purchase& x)
        : item(x.item), error(x.error)
    { }

    Purchase(const fb::protocol::marketplace::Item& item, uint32_t error)
        : item(item), error(error)
    { }

    Purchase(const fb::protocol::marketplace::response::raw::Purchase& raw)
        : item(*raw.item()), error(raw.error())
    { }
...
{
public:
    static inline fb::protocol::marketplace::response::FlatBufferProtocolType FlatBufferProtocolType = fb::protocol::marketplace::response::FlatBufferProtocolType::CheckListingStatus;
...
public:
    ...
    CheckListingStatus(const std::string& listing_id, uint32_t error)
        : listing_id(listing_id), error(error)
    { }

    CheckListingStatus(const fb::protocol::marketplace::response::raw::CheckListingStatus& raw)
        : listing_id(flatbuffers::option::decode(raw.listing_id()->c_str())), error(raw.error())
    { }
...
public:
    ...
    {
        auto builder = flatbuffers::FlatBufferBuilder();
        builder.Finish(build<fb::protocol::marketplace::response::CheckListingStatus>(builder, *this));
        auto buffer = std::vector<uint8_t>(builder.GetSize());
        std::memcpy(buffer.data(), builder.GetBufferPointer(), builder.GetSize());
        return buffer;
    }
    ...
    static CheckListingStatus Deserialize(const uint8_t* bytes)
    {
        auto raw = fb::protocol::marketplace::response::raw::GetCheckListingStatus(bytes);
        return CheckListingStatus(*raw);
    }
};
class GetListings
...
flatbuffers::Offset<fb::protocol::marketplace::request::raw::AllocateListingId> build<fb::protocol::marketplace::request::AllocateListingId>(FlatBufferBuilder& builder, const fb::protocol::marketplace::request::AllocateListingId& value)
{
    return fb::protocol::marketplace::request::raw::CreateAllocateListingId(builder,
...
flatbuffers::Offset<fb::protocol::marketplace::request::raw::CheckListingStatus> build<fb::protocol::marketplace::request::CheckListingStatus>(FlatBufferBuilder& builder, const fb::protocol::marketplace::request::CheckListingStatus& value)
{
    return fb::protocol::marketplace::request::raw::CreateCheckListingStatus(builder,
            flatbuffers::build<std::string>(builder, value.listing_id));
}
template <>
flatbuffers::Offset<fb::protocol::marketplace::request::raw::GetListings> build<fb::protocol::marketplace::request::GetListings>(FlatBufferBuilder& builder, const fb::protocol::marketplace::request::GetListings& value)
...
flatbuffers::Offset<fb::protocol::marketplace::response::raw::AllocateListingId> build<fb::protocol::marketplace::response::AllocateListingId>(FlatBufferBuilder& builder, const fb::protocol::marketplace::response::AllocateListingId& value)
{
    return fb::protocol::marketplace::response::raw::CreateAllocateListingId(builder,
            flatbuffers::build<std::string>(builder, value.listing_id),
            flatbuffers::build<uint32_t>(builder, value.error));
}
template <>
...
flatbuffers::Offset<fb::protocol::marketplace::response::raw::CheckListingStatus> build<fb::protocol::marketplace::response::CheckListingStatus>(FlatBufferBuilder& builder, const fb::protocol::marketplace::response::CheckListingStatus& value)
{
    return fb::protocol::marketplace::response::raw::CreateCheckListingStatus(builder,
            flatbuffers::build<std::string>(builder, value.listing_id),
            flatbuffers::build<uint32_t>(builder, value.error));
}
template <>
