...
#ifndef FLATBUFFERS_GENERATED_INTERNALREQUESTTRANSFER_FB_PROTOCOL_FLATBUFFER_INTER_REQUEST_H_
#define FLATBUFFERS_GENERATED_INTERNALREQUESTTRANSFER_FB_PROTOCOL_FLATBUFFER_INTER_REQUEST_H_
...
struct Transfer FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  fb::protocol::flatbuffer::inter::request::Service from() const {
    return static_cast<fb::protocol::flatbuffer::inter::request::Service>(GetField<int8_t>(VT_FROM, 0));
  }
  fb::protocol::flatbuffer::inter::request::Service to() const {
    return static_cast<fb::protocol::flatbuffer::inter::request::Service>(GetField<int8_t>(VT_TO, 0));
  }
  uint16_t map() const {
...
struct TransferBuilder {
  ...
  void add_from(fb::protocol::flatbuffer::inter::request::Service from) {
    fbb_.AddElement<int8_t>(Transfer::VT_FROM, static_cast<int8_t>(from), 0);
  }
  void add_to(fb::protocol::flatbuffer::inter::request::Service to) {
...
inline ::flatbuffers::Offset<Transfer> CreateTransfer(
    ...
    fb::protocol::flatbuffer::inter::request::Service from = fb::protocol::flatbuffer::inter::request::Service_Gateway,
    fb::protocol::flatbuffer::inter::request::Service to = fb::protocol::flatbuffer::inter::request::Service_Gateway,
    uint16_t map = 0,
    uint16_t x = 0,
    uint16_t y = 0,
    uint32_t fd = 0) {
...
inline ::flatbuffers::Offset<Transfer> CreateTransferDirect(
  ...
  return fb::protocol::flatbuffer::inter::request::CreateTransfer(
      _fbb,
      name__,
      from,
      to,
...
inline const fb::protocol::flatbuffer::inter::request::Transfer *GetTransfer(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::flatbuffer::inter::request::Transfer>(buf);
}

inline const fb::protocol::flatbuffer::inter::request::Transfer *GetSizePrefixedTransfer(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::flatbuffer::inter::request::Transfer>(buf);
}

inline bool VerifyTransferBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::flatbuffer::inter::request::Transfer>(nullptr);
}

inline bool VerifySizePrefixedTransferBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::flatbuffer::inter::request::Transfer>(nullptr);
}

inline void FinishTransferBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::flatbuffer::inter::request::Transfer> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_INTERNALREQUESTTRANSFER_FB_PROTOCOL_FLATBUFFER_INTER_REQUEST_H_
