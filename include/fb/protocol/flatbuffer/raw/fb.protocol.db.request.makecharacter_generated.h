...
#ifndef FLATBUFFERS_GENERATED_FBPROTOCOLDBREQUESTMAKECHARACTER_FB_PROTOCOL_DB_REQUEST_RAW_H_
#define FLATBUFFERS_GENERATED_FBPROTOCOLDBREQUESTMAKECHARACTER_FB_PROTOCOL_DB_REQUEST_RAW_H_
...
inline const fb::protocol::db::request::raw::MakeCharacter *GetMakeCharacter(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::db::request::raw::MakeCharacter>(buf);
}

inline const fb::protocol::db::request::raw::MakeCharacter *GetSizePrefixedMakeCharacter(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::db::request::raw::MakeCharacter>(buf);
}

inline bool VerifyMakeCharacterBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::db::request::raw::MakeCharacter>(nullptr);
}

inline bool VerifySizePrefixedMakeCharacterBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::db::request::raw::MakeCharacter>(nullptr);
}

inline void FinishMakeCharacterBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::db::request::raw::MakeCharacter> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_FBPROTOCOLDBREQUESTMAKECHARACTER_FB_PROTOCOL_DB_REQUEST_RAW_H_
