...
#ifndef FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALARTICLESUMMARY_FB_PROTOCOL_INTERNAL_RAW_H_
#define FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALARTICLESUMMARY_FB_PROTOCOL_INTERNAL_RAW_H_
...
inline ::flatbuffers::Offset<ArticleSummary> CreateArticleSummaryDirect(
  ...
  return fb::protocol::internal::raw::CreateArticleSummary(
      _fbb,
      id,
      user,
      user_name__,
...
inline const fb::protocol::internal::raw::ArticleSummary *GetArticleSummary(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::internal::raw::ArticleSummary>(buf);
}

inline const fb::protocol::internal::raw::ArticleSummary *GetSizePrefixedArticleSummary(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::internal::raw::ArticleSummary>(buf);
}

inline bool VerifyArticleSummaryBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::internal::raw::ArticleSummary>(nullptr);
}

inline bool VerifySizePrefixedArticleSummaryBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::internal::raw::ArticleSummary>(nullptr);
}

inline void FinishArticleSummaryBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::internal::raw::ArticleSummary> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALARTICLESUMMARY_FB_PROTOCOL_INTERNAL_RAW_H_
