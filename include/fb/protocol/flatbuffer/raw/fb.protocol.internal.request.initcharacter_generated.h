...
#ifndef FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALREQUESTINITCHARACTER_FB_PROTOCOL_INTERNAL_REQUEST_RAW_H_
#define FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALREQUESTINITCHARACTER_FB_PROTOCOL_INTERNAL_REQUEST_RAW_H_
...
inline const fb::protocol::internal::request::raw::InitCharacter *GetInitCharacter(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::internal::request::raw::InitCharacter>(buf);
}

inline const fb::protocol::internal::request::raw::InitCharacter *GetSizePrefixedInitCharacter(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::internal::request::raw::InitCharacter>(buf);
}

inline bool VerifyInitCharacterBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::internal::request::raw::InitCharacter>(nullptr);
}

inline bool VerifySizePrefixedInitCharacterBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::internal::request::raw::InitCharacter>(nullptr);
}

inline void FinishInitCharacterBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::internal::request::raw::InitCharacter> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALREQUESTINITCHARACTER_FB_PROTOCOL_INTERNAL_REQUEST_RAW_H_
