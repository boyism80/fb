...
#ifndef FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALREQUESTWHISPER_FB_PROTOCOL_INTERNAL_REQUEST_RAW_H_
#define FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALREQUESTWHISPER_FB_PROTOCOL_INTERNAL_REQUEST_RAW_H_
...
struct WhisperBuilder {
  ...
  void add_section(::flatbuffers::Offset<::flatbuffers::String> section) {
    fbb_.AddOffset(Whisper::VT_SECTION, section);
  }
...
inline const fb::protocol::internal::request::raw::Whisper *GetWhisper(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::internal::request::raw::Whisper>(buf);
}

inline const fb::protocol::internal::request::raw::Whisper *GetSizePrefixedWhisper(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::internal::request::raw::Whisper>(buf);
}

inline bool VerifyWhisperBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::internal::request::raw::Whisper>(nullptr);
}

inline bool VerifySizePrefixedWhisperBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::internal::request::raw::Whisper>(nullptr);
}

inline void FinishWhisperBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::internal::request::raw::Whisper> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALREQUESTWHISPER_FB_PROTOCOL_INTERNAL_REQUEST_RAW_H_
