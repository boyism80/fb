...
{
public:
    using bot_controller_type = gateway_bot_controller; ///< Type alias for the bot_controller type

public:
    /**
     * @brief      Constructs a new gateway bot instance.
     *
     * @param      bot_controller  The gateway bot bot_controller that manages this bot.
