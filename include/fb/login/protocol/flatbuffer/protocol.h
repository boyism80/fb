...
public:
    ...
    Init(const Init& x)
        : character(x.character), group(x.group), clan(x.clan), items(x.items), spells(x.spells), option(x.option), achievements(x.achievements)
    { }
