...
#ifndef FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALSPELL_FB_PROTOCOL_INTERNAL_RAW_H_
#define FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALSPELL_FB_PROTOCOL_INTERNAL_RAW_H_
...
inline const fb::protocol::internal::raw::Spell *GetSpell(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::internal::raw::Spell>(buf);
}

inline const fb::protocol::internal::raw::Spell *GetSizePrefixedSpell(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::internal::raw::Spell>(buf);
}

inline bool VerifySpellBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::internal::raw::Spell>(nullptr);
}

inline bool VerifySizePrefixedSpellBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::internal::raw::Spell>(nullptr);
}

inline void FinishSpellBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::internal::raw::Spell> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALSPELL_FB_PROTOCOL_INTERNAL_RAW_H_
