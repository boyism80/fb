...
#ifndef FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALARTICLE_FB_PROTOCOL_INTERNAL_RAW_H_
#define FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALARTICLE_FB_PROTOCOL_INTERNAL_RAW_H_
...
inline ::flatbuffers::Offset<Article> CreateArticleDirect(
  ...
  return fb::protocol::internal::raw::CreateArticle(
      _fbb,
      id,
      user,
      user_name__,
...
inline const fb::protocol::internal::raw::Article *GetArticle(const void *buf) {
  return ::flatbuffers::GetRoot<fb::protocol::internal::raw::Article>(buf);
}

inline const fb::protocol::internal::raw::Article *GetSizePrefixedArticle(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<fb::protocol::internal::raw::Article>(buf);
}

inline bool VerifyArticleBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<fb::protocol::internal::raw::Article>(nullptr);
}

inline bool VerifySizePrefixedArticleBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<fb::protocol::internal::raw::Article>(nullptr);
}

inline void FinishArticleBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<fb::protocol::internal::raw::Article> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_FBPROTOCOLINTERNALARTICLE_FB_PROTOCOL_INTERNAL_RAW_H_
