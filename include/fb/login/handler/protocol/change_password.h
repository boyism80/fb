...
class change_password : public fb::handler::protocol<fb::login::server, login_reqs::update_pw<V>>
{
public:
    ...
    async::task<bool> handle(fb::socket<fb::login::session>& session, login_reqs::update_pw<V>& request) override;
};
