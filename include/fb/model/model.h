 ...
 *          Generation timestamp: 18 Nov 2025
 */
...
inline STATE_LEVEL enum_parse<STATE_LEVEL>(const std::string k)
{
    ...
    auto i = enums.find(k);
    if (i == enums.end())
        throw std::runtime_error(std::format("{} is not a valid type in {}", k, "STATE_LEVEL"));
...
inline const char* enum_tostring<STATE_LEVEL>(STATE_LEVEL k)
{
    ...
    auto i = enums.find(k);
    if (i == enums.end())
        throw std::runtime_error(std::format("{} is not a valid value in {}", static_cast<uint32_t>(k), "STATE_LEVEL"));
...
template <>
inline void enum_map<fb::model::enum_value::STATE_LEVEL>(lua_State* lua)
{
    lua_newtable(lua);
    lua_pushinteger(lua, static_cast<lua_Integer>(fb::model::enum_value::STATE_LEVEL::CROWD_CONTROL));
    lua_setfield(lua, -2, "CROWD_CONTROL");
    lua_pushinteger(lua, static_cast<lua_Integer>(fb::model::enum_value::STATE_LEVEL::EXP_MONEY));
    lua_setfield(lua, -2, "EXP_MONEY");
    lua_pushinteger(lua, static_cast<lua_Integer>(fb::model::enum_value::STATE_LEVEL::HP_MP));
    lua_setfield(lua, -2, "HP_MP");
    lua_pushinteger(lua, static_cast<lua_Integer>(fb::model::enum_value::STATE_LEVEL::BASED));
    lua_setfield(lua, -2, "BASED");
    lua_pushinteger(lua, static_cast<lua_Integer>(fb::model::enum_value::STATE_LEVEL::LEVEL_MAX));
    lua_setfield(lua, -2, "LEVEL_MAX");
    lua_pushinteger(lua, static_cast<lua_Integer>(fb::model::enum_value::STATE_LEVEL::LEVEL_MIN));
    lua_setfield(lua, -2, "LEVEL_MIN");
    lua_pushinteger(lua, static_cast<lua_Integer>(fb::model::enum_value::STATE_LEVEL::LEVEL_MIDDLE));
    lua_setfield(lua, -2, "LEVEL_MIDDLE");
    lua_setglobal(lua, "STATE_LEVEL");
}
...
inline static void map_enum(lua_State* lua)
{
    ...
    enum_map<fb::model::enum_value::STATE_LEVEL>(lua);
