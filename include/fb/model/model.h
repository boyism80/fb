...
template <>
inline const char* enum_tostring<STATE_LEVEL>(STATE_LEVEL k)
{
    static const std::unordered_map<STATE_LEVEL, const char*> enums
    {
        ...
        { STATE_LEVEL::LEVEL_MAX, "LEVEL_MAX" }, 
        { STATE_LEVEL::LEVEL_MIN, "LEVEL_MIN" }, 
        { STATE_LEVEL::LEVEL_MIDDLE, "LEVEL_MIDDLE" }
    };
...
{
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ACTION::ATTACK);
    lua_setglobal(lua, "ACTION_ATTACK");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ACTION::ARROW);
    lua_setglobal(lua, "ACTION_ARROW");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ACTION::PICKUP);
    lua_setglobal(lua, "ACTION_PICKUP");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ACTION::PICKUP_SILENT);
    lua_setglobal(lua, "ACTION_PICKUP_SILENT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ACTION::CAST_SPELL);
    lua_setglobal(lua, "ACTION_CAST_SPELL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ACTION::EAT);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::CHAT_TYPE::BLUE);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::CREATURE::TURTLE);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DEATH_PENALTY::DESTROY);
    lua_setglobal(lua, "DEATH_PENALTY_DESTROY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DESTROY_TYPE::DEFAULT);
    lua_setglobal(lua, "DESTROY_TYPE_DEFAULT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DESTROY_TYPE::DEAD);
    lua_setglobal(lua, "DESTROY_TYPE_DEAD");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DIALOG_RESULT::PREV);
    lua_setglobal(lua, "DIALOG_RESULT_PREV");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DIALOG_RESULT::QUIT);
    lua_setglobal(lua, "DIALOG_RESULT_QUIT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DIALOG_RESULT::NEXT);
    lua_setglobal(lua, "DIALOG_RESULT_NEXT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DIRECTION::TOP);
    lua_setglobal(lua, "DIRECTION_TOP");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DIRECTION::RIGHT);
    lua_setglobal(lua, "DIRECTION_RIGHT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DIRECTION::BOTTOM);
    lua_setglobal(lua, "DIRECTION_BOTTOM");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DIRECTION::LEFT);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DSL::strength);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DURATION::SPELL);
    lua_setglobal(lua, "DURATION_SPELL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DURATION::EAT);
    lua_setglobal(lua, "DURATION_EAT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DURATION::THROW);
    lua_setglobal(lua, "DURATION_THROW");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DURATION::PICKUP);
    lua_setglobal(lua, "DURATION_PICKUP");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DURATION::EMOTION);
    lua_setglobal(lua, "DURATION_EMOTION");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::UNKNOWN);
    lua_setglobal(lua, "EQUIPMENT_PARTS_UNKNOWN");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::WEAPON);
    lua_setglobal(lua, "EQUIPMENT_PARTS_WEAPON");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::ARMOR);
    lua_setglobal(lua, "EQUIPMENT_PARTS_ARMOR");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::SHIELD);
    lua_setglobal(lua, "EQUIPMENT_PARTS_SHIELD");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::HELMET);
    lua_setglobal(lua, "EQUIPMENT_PARTS_HELMET");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::LEFT_HAND);
    lua_setglobal(lua, "EQUIPMENT_PARTS_LEFT_HAND");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::RIGHT_HAND);
    lua_setglobal(lua, "EQUIPMENT_PARTS_RIGHT_HAND");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::LEFT_AUX);
    lua_setglobal(lua, "EQUIPMENT_PARTS_LEFT_AUX");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_PARTS::RIGHT_AUX);
    lua_setglobal(lua, "EQUIPMENT_PARTS_RIGHT_AUX");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::EQUIPMENT_POSITION::LEFT);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::BUNDLE);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_BUNDLE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::SCRIPT);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_SCRIPT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::CASH);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_CASH");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::EQUIPMENT);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_EQUIPMENT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::PACK);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_PACK");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::WEAPON);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_WEAPON");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::ARMOR);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_ARMOR");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::SHIELD);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_SHIELD");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::HELMET);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_HELMET");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::RING);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_RING");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::AUXILIARY);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_AUXILIARY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_ATTRIBUTE::ARROW);
    lua_setglobal(lua, "ITEM_ATTRIBUTE_ARROW");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::REMOVED);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_REMOVED");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::DROP);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_DROP");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::EAT);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_EAT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::SMOKE);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_SMOKE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::THROW);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_THROW");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::SHOOT);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_SHOOT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::REDUCE);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_REDUCE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::STICK);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_STICK");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::DECAY);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_DECAY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::GIVE);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_GIVE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::SELL);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_SELL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::NONE);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_NONE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_DELETE_TYPE::DESTROY);
    lua_setglobal(lua, "ITEM_DELETE_TYPE_DESTROY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::STUFF);
    lua_setglobal(lua, "ITEM_TYPE_STUFF");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::CASH);
    lua_setglobal(lua, "ITEM_TYPE_CASH");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::CONSUME);
    lua_setglobal(lua, "ITEM_TYPE_CONSUME");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::WEAPON);
    lua_setglobal(lua, "ITEM_TYPE_WEAPON");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::ARMOR);
    lua_setglobal(lua, "ITEM_TYPE_ARMOR");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::HELMET);
    lua_setglobal(lua, "ITEM_TYPE_HELMET");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::RING);
    lua_setglobal(lua, "ITEM_TYPE_RING");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::SHIELD);
    lua_setglobal(lua, "ITEM_TYPE_SHIELD");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::AUXILIARY);
    lua_setglobal(lua, "ITEM_TYPE_AUXILIARY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::ITEM_TYPE::BOW);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_EFFECT_TYPE::WATER);
    lua_setglobal(lua, "MAP_EFFECT_TYPE_WATER");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_OPTION::NONE);
    lua_setglobal(lua, "MAP_OPTION_NONE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_OPTION::BUILD_IN);
    lua_setglobal(lua, "MAP_OPTION_BUILD_IN");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_OPTION::DISABLE_TALK);
    lua_setglobal(lua, "MAP_OPTION_DISABLE_TALK");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_OPTION::DISABLE_WHISPER);
    lua_setglobal(lua, "MAP_OPTION_DISABLE_WHISPER");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_OPTION::DISABLE_SPELL);
    lua_setglobal(lua, "MAP_OPTION_DISABLE_SPELL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_OPTION::HUNTING_GROUND);
    lua_setglobal(lua, "MAP_OPTION_HUNTING_GROUND");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_OPTION::ENABLE_PK);
    lua_setglobal(lua, "MAP_OPTION_ENABLE_PK");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAP_OPTION::DISABLE_DIE_PENALTY);
    lua_setglobal(lua, "MAP_OPTION_DISABLE_DIE_PENALTY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MESSAGE_TYPE::NOTIFY);
    lua_setglobal(lua, "MESSAGE_TYPE_NOTIFY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MESSAGE_TYPE::BLUE);
    lua_setglobal(lua, "MESSAGE_TYPE_BLUE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MESSAGE_TYPE::STATE);
    lua_setglobal(lua, "MESSAGE_TYPE_STATE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MESSAGE_TYPE::SHOUT);
    lua_setglobal(lua, "MESSAGE_TYPE_SHOUT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MESSAGE_TYPE::WORLD);
    lua_setglobal(lua, "MESSAGE_TYPE_WORLD");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MESSAGE_TYPE::POPUP);
    lua_setglobal(lua, "MESSAGE_TYPE_POPUP");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MESSAGE_TYPE::YELLOW);
    lua_setglobal(lua, "MESSAGE_TYPE_YELLOW");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MESSAGE_TYPE::BROWN);
    lua_setglobal(lua, "MESSAGE_TYPE_BROWN");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MOB_ATTACK_TYPE::NONE);
    lua_setglobal(lua, "MOB_ATTACK_TYPE_NONE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MOB_ATTACK_TYPE::COUNTER);
    lua_setglobal(lua, "MOB_ATTACK_TYPE_COUNTER");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MOB_ATTACK_TYPE::CONTAINMENT);
    lua_setglobal(lua, "MOB_ATTACK_TYPE_CONTAINMENT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MOB_ATTACK_TYPE::RUN_AWAY);
    lua_setglobal(lua, "MOB_ATTACK_TYPE_RUN_AWAY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MOB_ATTACK_TYPE::NO_MOVE);
    lua_setglobal(lua, "MOB_ATTACK_TYPE_NO_MOVE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MOB_SIZE::SMALL);
    lua_setglobal(lua, "MOB_SIZE_SMALL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MOB_SIZE::LARGE);
    lua_setglobal(lua, "MOB_SIZE_LARGE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MOB_SIZE::ALL);
    lua_setglobal(lua, "MOB_SIZE_ALL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::NATION::GOGURYEO);
    lua_setglobal(lua, "NATION_GOGURYEO");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::NATION::BUYEO);
    lua_setglobal(lua, "NATION_BUYEO");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::OBJECT_TYPE::UNKNOWN);
    lua_setglobal(lua, "OBJECT_TYPE_UNKNOWN");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::OBJECT_TYPE::ITEM);
    lua_setglobal(lua, "OBJECT_TYPE_ITEM");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::OBJECT_TYPE::NPC);
    lua_setglobal(lua, "OBJECT_TYPE_NPC");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::OBJECT_TYPE::MOB);
    lua_setglobal(lua, "OBJECT_TYPE_MOB");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::OBJECT_TYPE::CHARACTER);
    lua_setglobal(lua, "OBJECT_TYPE_CHARACTER");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::OBJECT_TYPE::OBJECT);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::REPAIR);
    lua_setglobal(lua, "REGEX_REPAIR");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::DEPOSIT_MONEY);
    lua_setglobal(lua, "REGEX_DEPOSIT_MONEY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::WITHDRAW_MONEY);
    lua_setglobal(lua, "REGEX_WITHDRAW_MONEY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::DEPOSIT_ITEM);
    lua_setglobal(lua, "REGEX_DEPOSIT_ITEM");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::WITHDRAW_ITEM);
    lua_setglobal(lua, "REGEX_WITHDRAW_ITEM");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::SELL_LIST);
    lua_setglobal(lua, "REGEX_SELL_LIST");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::BUY_LIST);
    lua_setglobal(lua, "REGEX_BUY_LIST");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::SELL_PRICE);
    lua_setglobal(lua, "REGEX_SELL_PRICE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::BUY_PRICE);
    lua_setglobal(lua, "REGEX_BUY_PRICE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::DEPOSITED_MONEY);
    lua_setglobal(lua, "REGEX_DEPOSITED_MONEY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::RENAME_WEAPON);
    lua_setglobal(lua, "REGEX_RENAME_WEAPON");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::REGEX::HOLD_ITEM_LIST);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SOUND::SWING);
    lua_setglobal(lua, "SOUND_SWING");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SOUND::DAMAGE);
    lua_setglobal(lua, "SOUND_DAMAGE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SOUND::EQUIPMENT_OFF);
    lua_setglobal(lua, "SOUND_EQUIPMENT_OFF");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SOUND::EQUIPMENT_ON);
    lua_setglobal(lua, "SOUND_EQUIPMENT_ON");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SPELL_TYPE::INPUT);
    lua_setglobal(lua, "SPELL_TYPE_INPUT");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SPELL_TYPE::TARGET);
    lua_setglobal(lua, "SPELL_TYPE_TARGET");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SPELL_TYPE::NORMAL);
    lua_setglobal(lua, "SPELL_TYPE_NORMAL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SPELL_TYPE::UNKNOWN1);
    lua_setglobal(lua, "SPELL_TYPE_UNKNOWN1");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SPELL_TYPE::UNKNOWN2);
    lua_setglobal(lua, "SPELL_TYPE_UNKNOWN2");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SPELL_TYPE::UNKNOWN3);
    lua_setglobal(lua, "SPELL_TYPE_UNKNOWN3");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE::NORMAL);
    lua_setglobal(lua, "STATE_NORMAL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE::GHOST);
    lua_setglobal(lua, "STATE_GHOST");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE::TRANSLUCENCY);
    lua_setglobal(lua, "STATE_TRANSLUCENCY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE::RIDING);
    lua_setglobal(lua, "STATE_RIDING");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE::DISGUISE);
    lua_setglobal(lua, "STATE_DISGUISE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE::HALF_CLOACK);
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE_LEVEL::BASED);
    lua_setglobal(lua, "STATE_LEVEL_BASED");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE_LEVEL::LEVEL_MAX);
    lua_setglobal(lua, "STATE_LEVEL_LEVEL_MAX");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE_LEVEL::LEVEL_MIN);
    lua_setglobal(lua, "STATE_LEVEL_LEVEL_MIN");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::STATE_LEVEL::LEVEL_MIDDLE);
    lua_setglobal(lua, "STATE_LEVEL_LEVEL_MIDDLE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SWAP_TYPE::ITEM);
    lua_setglobal(lua, "SWAP_TYPE_ITEM");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::SWAP_TYPE::SPELL);
    lua_setglobal(lua, "SWAP_TYPE_SPELL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::TIMER_TYPE::INCREASE);
    lua_setglobal(lua, "TIMER_TYPE_INCREASE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::TIMER_TYPE::DECREASE);
    lua_setglobal(lua, "TIMER_TYPE_DECREASE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::WEAPON_TYPE::NORMAL);
    lua_setglobal(lua, "WEAPON_TYPE_NORMAL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::WEAPON_TYPE::SPEAR);
    lua_setglobal(lua, "WEAPON_TYPE_SPEAR");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::WEAPON_TYPE::BOW);
    lua_setglobal(lua, "WEAPON_TYPE_BOW");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::WEAPON_TYPE::FAN);
    lua_setglobal(lua, "WEAPON_TYPE_FAN");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::WEAPON_TYPE::UNKNOWN);
    lua_setglobal(lua, "WEAPON_TYPE_UNKNOWN");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::WEATHER_TYPE::NORMAL);
    lua_setglobal(lua, "WEATHER_TYPE_NORMAL");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::WEATHER_TYPE::RAIN);
    lua_setglobal(lua, "WEATHER_TYPE_RAIN");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::WEATHER_TYPE::SNOW);
