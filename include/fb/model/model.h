 ...
 *          Generation timestamp: 05 Nov 2025
 */
...
inline static void map_enum(lua_State* lua)
{
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::DSL::exp);
    lua_setglobal(lua, "DSL_exp");
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::MAIL_BUTTON_ENABLE::UP);
    lua_setglobal(lua, "MAIL_BUTTON_ENABLE_UP");
    ...
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::NPC_INTERACTION::NONE);
    lua_setglobal(lua, "NPC_INTERACTION_NONE");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::NPC_INTERACTION::REPAIR);
    lua_setglobal(lua, "NPC_INTERACTION_REPAIR");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::NPC_INTERACTION::RENAME);
    lua_setglobal(lua, "NPC_INTERACTION_RENAME");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::NPC_INTERACTION::DEPOSIT_MONEY);
    lua_setglobal(lua, "NPC_INTERACTION_DEPOSIT_MONEY");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::NPC_INTERACTION::STORE_ITEM);
    lua_setglobal(lua, "NPC_INTERACTION_STORE_ITEM");
    lua_pushinteger(lua, (lua_Integer)fb::model::enum_value::NPC_INTERACTION::REVIVE);
    lua_setglobal(lua, "NPC_INTERACTION_REVIVE");
