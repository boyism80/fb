...
public struct Ping : IFlatbufferObject
{
  ...
  public static Offset<fb.game.flatbuffer.db.Ping> EndPing(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.game.flatbuffer.db.Ping>(o);
  }
  public static void FinishPingBuffer(FlatBufferBuilder builder, Offset<fb.game.flatbuffer.db.Ping> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedPingBuffer(FlatBufferBuilder builder, Offset<fb.game.flatbuffer.db.Ping> offset) { builder.FinishSizePrefixed(offset.Value); }
}
