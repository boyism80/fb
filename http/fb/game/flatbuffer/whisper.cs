...
public struct whisper : IFlatbufferObject
{
  ...
  public static Offset<fb.game.flatbuffer.whisper> Createwhisper(FlatBufferBuilder builder,
  ...
  public static Offset<fb.game.flatbuffer.whisper> Endwhisper(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.game.flatbuffer.whisper>(o);
  }
  public static void FinishwhisperBuffer(FlatBufferBuilder builder, Offset<fb.game.flatbuffer.whisper> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedwhisperBuffer(FlatBufferBuilder builder, Offset<fb.game.flatbuffer.whisper> offset) { builder.FinishSizePrefixed(offset.Value); }
}
