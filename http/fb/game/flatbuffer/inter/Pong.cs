...
public struct Pong : IFlatbufferObject
{
  ...
  public static Offset<fb.game.flatbuffer.inter.Pong> EndPong(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.game.flatbuffer.inter.Pong>(o);
  }
  public static void FinishPongBuffer(FlatBufferBuilder builder, Offset<fb.game.flatbuffer.inter.Pong> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedPongBuffer(FlatBufferBuilder builder, Offset<fb.game.flatbuffer.inter.Pong> offset) { builder.FinishSizePrefixed(offset.Value); }
}
