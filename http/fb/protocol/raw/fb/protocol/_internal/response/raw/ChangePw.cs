...
public struct ChangePw : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.response.raw.ChangePw> CreateChangePw(FlatBufferBuilder builder,
      uint error_code = 0) {
  ...
  public static Offset<fb.protocol._internal.response.raw.ChangePw> EndChangePw(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.response.raw.ChangePw>(o);
  }
  public static void FinishChangePwBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.ChangePw> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedChangePwBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.ChangePw> offset) { builder.FinishSizePrefixed(offset.Value); }
}
