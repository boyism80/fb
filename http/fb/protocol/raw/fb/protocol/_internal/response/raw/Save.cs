...
public struct Save : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.response.raw.Save> CreateSave(FlatBufferBuilder builder,
      bool success = false) {
    builder.StartTable(1);
    Save.AddSuccess(builder, success);
    return Save.EndSave(builder);
  }

  public static void StartSave(FlatBufferBuilder builder) { builder.StartTable(1); }
  public static void AddSuccess(FlatBufferBuilder builder, bool success) { builder.AddBool(0, success, false); }
  public static Offset<fb.protocol._internal.response.raw.Save> EndSave(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.response.raw.Save>(o);
  }
  public static void FinishSaveBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.Save> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedSaveBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.Save> offset) { builder.FinishSizePrefixed(offset.Value); }
}
