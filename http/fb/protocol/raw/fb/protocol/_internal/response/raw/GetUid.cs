...
public struct GetUid : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.response.raw.GetUid> CreateGetUid(FlatBufferBuilder builder,
      uint uid = 0,
      bool success = false) {
  ...
  public static Offset<fb.protocol._internal.response.raw.GetUid> EndGetUid(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.response.raw.GetUid>(o);
  }
  public static void FinishGetUidBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.GetUid> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedGetUidBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.GetUid> offset) { builder.FinishSizePrefixed(offset.Value); }
}
