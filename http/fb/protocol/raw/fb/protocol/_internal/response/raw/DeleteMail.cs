...
public struct DeleteMail : IFlatbufferObject
{
  ...
  public static void FinishDeleteMailBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.DeleteMail> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedDeleteMailBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.DeleteMail> offset) { builder.FinishSizePrefixed(offset.Value); }
}
