...
public struct Login : IFlatbufferObject
{
  ...
  public static void FinishLoginBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.Login> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedLoginBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.Login> offset) { builder.FinishSizePrefixed(offset.Value); }
}
