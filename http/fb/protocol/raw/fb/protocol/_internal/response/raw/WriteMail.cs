...
public struct WriteMail : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.response.raw.WriteMail> EndWriteMail(FlatBufferBuilder builder) {
    ...
    return new Offset<fb.protocol._internal.response.raw.WriteMail>(o);
  }
  public static void FinishWriteMailBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.WriteMail> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedWriteMailBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.response.raw.WriteMail> offset) { builder.FinishSizePrefixed(offset.Value); }
}
