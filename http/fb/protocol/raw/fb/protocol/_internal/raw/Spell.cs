...
public struct Spell : IFlatbufferObject
{
  ...
  public static void FinishSpellBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.raw.Spell> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedSpellBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.raw.Spell> offset) { builder.FinishSizePrefixed(offset.Value); }
}
