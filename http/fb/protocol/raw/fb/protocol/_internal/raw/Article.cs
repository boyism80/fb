...
public struct Article : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.raw.Article> CreateArticle(FlatBufferBuilder builder,
      uint id = 0,
      uint user = 0,
  ...
  public static Offset<fb.protocol._internal.raw.Article> EndArticle(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.raw.Article>(o);
  }
  public static void FinishArticleBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.raw.Article> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedArticleBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.raw.Article> offset) { builder.FinishSizePrefixed(offset.Value); }
}
