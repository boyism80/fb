...
public struct ArticleSummary : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.raw.ArticleSummary> CreateArticleSummary(FlatBufferBuilder builder,
      uint id = 0,
      uint user = 0,
  ...
  public static Offset<fb.protocol._internal.raw.ArticleSummary> EndArticleSummary(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.raw.ArticleSummary>(o);
  }
  public static void FinishArticleSummaryBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.raw.ArticleSummary> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedArticleSummaryBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.raw.ArticleSummary> offset) { builder.FinishSizePrefixed(offset.Value); }
}
