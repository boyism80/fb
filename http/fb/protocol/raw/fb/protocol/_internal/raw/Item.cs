...
public struct Item : IFlatbufferObject
{
  ...
  public static void FinishItemBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.raw.Item> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedItemBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.raw.Item> offset) { builder.FinishSizePrefixed(offset.Value); }
}
