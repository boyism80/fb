...
public struct GetArticle : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.request.raw.GetArticle> CreateGetArticle(FlatBufferBuilder builder,
      uint section = 0,
      uint article = 0) {
  ...
  public static Offset<fb.protocol._internal.request.raw.GetArticle> EndGetArticle(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.request.raw.GetArticle>(o);
  }
  public static void FinishGetArticleBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.request.raw.GetArticle> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedGetArticleBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.request.raw.GetArticle> offset) { builder.FinishSizePrefixed(offset.Value); }
}
