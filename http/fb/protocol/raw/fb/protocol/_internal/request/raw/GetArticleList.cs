...
public struct GetArticleList : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol._internal.request.raw.GetArticleList> CreateGetArticleList(FlatBufferBuilder builder,
      uint section = 0,
      uint position = 0) {
  ...
  public static Offset<fb.protocol._internal.request.raw.GetArticleList> EndGetArticleList(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol._internal.request.raw.GetArticleList>(o);
  }
  public static void FinishGetArticleListBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.request.raw.GetArticleList> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedGetArticleListBuffer(FlatBufferBuilder builder, Offset<fb.protocol._internal.request.raw.GetArticleList> offset) { builder.FinishSizePrefixed(offset.Value); }
}
