...
public struct ChangePw : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.request.raw.ChangePw> CreateChangePw(FlatBufferBuilder builder,
      uint uid = 0,
  ...
  public static Offset<fb.protocol.db.request.raw.ChangePw> EndChangePw(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.request.raw.ChangePw>(o);
  }
  public static void FinishChangePwBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.raw.ChangePw> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedChangePwBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.raw.ChangePw> offset) { builder.FinishSizePrefixed(offset.Value); }
}
