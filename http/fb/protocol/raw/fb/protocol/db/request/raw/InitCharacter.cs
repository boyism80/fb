...
public struct InitCharacter : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.request.raw.InitCharacter> CreateInitCharacter(FlatBufferBuilder builder,
      uint uid = 0,
  ...
  public static Offset<fb.protocol.db.request.raw.InitCharacter> EndInitCharacter(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.request.raw.InitCharacter>(o);
  }
  public static void FinishInitCharacterBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.raw.InitCharacter> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedInitCharacterBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.raw.InitCharacter> offset) { builder.FinishSizePrefixed(offset.Value); }
}
