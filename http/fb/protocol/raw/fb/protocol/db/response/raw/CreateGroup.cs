...
public struct CreateGroup : IFlatbufferObject
{
  ...
  public fb.protocol.db.raw.Group? Group { get { int o = __p.__offset(4); return o != 0 ? (fb.protocol.db.raw.Group?)(new fb.protocol.db.raw.Group()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static Offset<fb.protocol.db.response.raw.CreateGroup> CreateCreateGroup(FlatBufferBuilder builder,
  ...
  public static void AddGroup(FlatBufferBuilder builder, Offset<fb.protocol.db.raw.Group> groupOffset) { builder.AddOffset(0, groupOffset.Value, 0); }
  ...
  public static Offset<fb.protocol.db.response.raw.CreateGroup> EndCreateGroup(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.response.raw.CreateGroup>(o);
  }
  public static void FinishCreateGroupBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.raw.CreateGroup> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedCreateGroupBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.raw.CreateGroup> offset) { builder.FinishSizePrefixed(offset.Value); }
}
...
static public class CreateGroupVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyTable(tablePos, 4 /*Group*/, fb.protocol.db.raw.GroupVerify.Verify, false)
