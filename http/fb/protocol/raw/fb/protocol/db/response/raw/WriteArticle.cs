...
public struct WriteArticle : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.response.raw.WriteArticle> CreateWriteArticle(FlatBufferBuilder builder,
      bool success = false) {
  ...
  public static Offset<fb.protocol.db.response.raw.WriteArticle> EndWriteArticle(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.response.raw.WriteArticle>(o);
  }
  public static void FinishWriteArticleBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.raw.WriteArticle> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedWriteArticleBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.raw.WriteArticle> offset) { builder.FinishSizePrefixed(offset.Value); }
}
