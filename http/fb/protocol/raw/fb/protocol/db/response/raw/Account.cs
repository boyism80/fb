...
public struct Account : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.response.raw.Account> CreateAccount(FlatBufferBuilder builder,
  ...
  public static Offset<fb.protocol.db.response.raw.Account> EndAccount(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.response.raw.Account>(o);
  }
  public static void FinishAccountBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.raw.Account> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedAccountBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.raw.Account> offset) { builder.FinishSizePrefixed(offset.Value); }
}
