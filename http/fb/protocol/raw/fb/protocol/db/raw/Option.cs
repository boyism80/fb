...
public struct Option : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.raw.Option> CreateOption(FlatBufferBuilder builder,
      uint uid = 0,
      bool whisper = false,
      bool group = false,
      bool roar = false,
  ...
  public static Offset<fb.protocol.db.raw.Option> EndOption(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.raw.Option>(o);
  }
  public static void FinishOptionBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.raw.Option> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedOptionBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.raw.Option> offset) { builder.FinishSizePrefixed(offset.Value); }
}
