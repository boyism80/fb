...
public struct Whisper : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.flatbuffer.inter.request.Whisper> CreateWhisper(FlatBufferBuilder builder,
  ...
  public static Offset<fb.protocol.flatbuffer.inter.request.Whisper> EndWhisper(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.flatbuffer.inter.request.Whisper>(o);
  }
  public static void FinishWhisperBuffer(FlatBufferBuilder builder, Offset<fb.protocol.flatbuffer.inter.request.Whisper> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedWhisperBuffer(FlatBufferBuilder builder, Offset<fb.protocol.flatbuffer.inter.request.Whisper> offset) { builder.FinishSizePrefixed(offset.Value); }
}
