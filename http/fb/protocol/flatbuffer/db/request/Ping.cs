...
public struct Ping : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.flatbuffer.db.request.Ping> EndPing(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.flatbuffer.db.request.Ping>(o);
  }
  public static void FinishPingBuffer(FlatBufferBuilder builder, Offset<fb.protocol.flatbuffer.db.request.Ping> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedPingBuffer(FlatBufferBuilder builder, Offset<fb.protocol.flatbuffer.db.request.Ping> offset) { builder.FinishSizePrefixed(offset.Value); }
}
