...
public struct Ping : IFlatbufferObject
{
  ...
  public static void FinishPingBuffer(FlatBufferBuilder builder, Offset<fb.protocol.inter.request.origin.Ping> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedPingBuffer(FlatBufferBuilder builder, Offset<fb.protocol.inter.request.origin.Ping> offset) { builder.FinishSizePrefixed(offset.Value); }
}
