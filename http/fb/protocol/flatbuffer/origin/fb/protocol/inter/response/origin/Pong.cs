...
public struct Pong : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.inter.response.origin.Pong> EndPong(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.inter.response.origin.Pong>(o);
  }
  public static void FinishPongBuffer(FlatBufferBuilder builder, Offset<fb.protocol.inter.response.origin.Pong> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedPongBuffer(FlatBufferBuilder builder, Offset<fb.protocol.inter.response.origin.Pong> offset) { builder.FinishSizePrefixed(offset.Value); }
}
