...
public struct ChangePw : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.response.origin.ChangePw> CreateChangePw(FlatBufferBuilder builder,
      int result = 0) {
  ...
  public static Offset<fb.protocol.db.response.origin.ChangePw> EndChangePw(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.response.origin.ChangePw>(o);
  }
  public static void FinishChangePwBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.origin.ChangePw> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedChangePwBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.origin.ChangePw> offset) { builder.FinishSizePrefixed(offset.Value); }
}
