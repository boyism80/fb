...
public struct Save : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.response.origin.Save> CreateSave(FlatBufferBuilder builder,
      bool success = false) {
  ...
  public static Offset<fb.protocol.db.response.origin.Save> EndSave(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.response.origin.Save>(o);
  }
  public static void FinishSaveBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.origin.Save> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedSaveBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.origin.Save> offset) { builder.FinishSizePrefixed(offset.Value); }
}
