...
public struct MakeCharacter : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.response.origin.MakeCharacter> CreateMakeCharacter(FlatBufferBuilder builder,
      bool success = false) {
  ...
  public static Offset<fb.protocol.db.response.origin.MakeCharacter> EndMakeCharacter(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.response.origin.MakeCharacter>(o);
  }
  public static void FinishMakeCharacterBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.origin.MakeCharacter> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedMakeCharacterBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.response.origin.MakeCharacter> offset) { builder.FinishSizePrefixed(offset.Value); }
}
