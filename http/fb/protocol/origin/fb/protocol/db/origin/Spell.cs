...
public struct Spell : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.origin.Spell> CreateSpell(FlatBufferBuilder builder,
      uint user = 0,
      byte slot = 0,
      uint id = 0) {
  ...
  public static Offset<fb.protocol.db.origin.Spell> EndSpell(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.origin.Spell>(o);
  }
}
