...
public struct Article : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.origin.Article> CreateArticle(FlatBufferBuilder builder,
      uint id = 0,
      uint user = 0,
  ...
  public static Offset<fb.protocol.db.origin.Article> EndArticle(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.origin.Article>(o);
  }
}
