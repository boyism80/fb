...
public struct Item : IFlatbufferObject
{
  ...
  public fb.protocol.db.origin.nullopt_uint? Durability { get { int o = __p.__offset(16); return o != 0 ? (fb.protocol.db.origin.nullopt_uint?)(new fb.protocol.db.origin.nullopt_uint()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public static Offset<fb.protocol.db.origin.Item> CreateItem(FlatBufferBuilder builder,
      uint user = 0,
      short index = 0,
      short parts = 0,
      short deposited = 0,
      uint model = 0,
      ushort count = 0,
      Offset<fb.protocol.db.origin.nullopt_uint> durabilityOffset = default(Offset<fb.protocol.db.origin.nullopt_uint>),
  ...
  public static void AddDurability(FlatBufferBuilder builder, Offset<fb.protocol.db.origin.nullopt_uint> durabilityOffset) { builder.AddOffset(6, durabilityOffset.Value, 0); }
  ...
  public static Offset<fb.protocol.db.origin.Item> EndItem(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.origin.Item>(o);
  }
}
...
static public class ItemVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyTable(tablePos, 16 /*Durability*/, fb.protocol.db.origin.nullopt_uintVerify.Verify, false)
