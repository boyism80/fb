...
public struct ArticleSummary : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.origin.ArticleSummary> CreateArticleSummary(FlatBufferBuilder builder,
      uint id = 0,
      uint user = 0,
  ...
  public static Offset<fb.protocol.db.origin.ArticleSummary> EndArticleSummary(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.origin.ArticleSummary>(o);
  }
}
