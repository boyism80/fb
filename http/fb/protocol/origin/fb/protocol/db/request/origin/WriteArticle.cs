...
public struct WriteArticle : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.request.origin.WriteArticle> CreateWriteArticle(FlatBufferBuilder builder,
      uint section = 0,
      uint user = 0,
  ...
  public static Offset<fb.protocol.db.request.origin.WriteArticle> EndWriteArticle(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.request.origin.WriteArticle>(o);
  }
  public static void FinishWriteArticleBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.WriteArticle> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedWriteArticleBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.WriteArticle> offset) { builder.FinishSizePrefixed(offset.Value); }
}
