...
public struct Login : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.request.origin.Login> CreateLogin(FlatBufferBuilder builder,
      uint uid = 0) {
  ...
  public static Offset<fb.protocol.db.request.origin.Login> EndLogin(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.request.origin.Login>(o);
  }
  public static void FinishLoginBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.Login> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedLoginBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.Login> offset) { builder.FinishSizePrefixed(offset.Value); }
}
