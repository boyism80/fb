...
public struct MakeCharacter : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.request.origin.MakeCharacter> CreateMakeCharacter(FlatBufferBuilder builder,
      uint uid = 0,
      ushort hair = 0,
      byte sex = 0,
      byte nation = 0,
  ...
  public static Offset<fb.protocol.db.request.origin.MakeCharacter> EndMakeCharacter(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.request.origin.MakeCharacter>(o);
  }
  public static void FinishMakeCharacterBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.MakeCharacter> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedMakeCharacterBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.MakeCharacter> offset) { builder.FinishSizePrefixed(offset.Value); }
}
