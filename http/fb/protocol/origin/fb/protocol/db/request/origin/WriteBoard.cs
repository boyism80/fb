...
public struct WriteBoard : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static WriteBoard GetRootAsWriteBoard(ByteBuffer _bb) { return GetRootAsWriteBoard(_bb, new WriteBoard()); }
  public static WriteBoard GetRootAsWriteBoard(ByteBuffer _bb, WriteBoard obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool VerifyWriteBoard(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("", false, WriteBoardVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public WriteBoard __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<fb.protocol.db.request.origin.WriteBoard> CreateWriteBoard(FlatBufferBuilder builder,
      uint section = 0,
      uint user = 0,
      StringOffset titleOffset = default(StringOffset),
      StringOffset contentsOffset = default(StringOffset)) {
    builder.StartTable(4);
    WriteBoard.AddContents(builder, contentsOffset);
    WriteBoard.AddTitle(builder, titleOffset);
    WriteBoard.AddUser(builder, user);
    WriteBoard.AddSection(builder, section);
    return WriteBoard.EndWriteBoard(builder);
  }

  public static void StartWriteBoard(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<fb.protocol.db.request.origin.WriteBoard> EndWriteBoard(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.request.origin.WriteBoard>(o);
  }
  public static void FinishWriteBoardBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.WriteBoard> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedWriteBoardBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.WriteBoard> offset) { builder.FinishSizePrefixed(offset.Value); }
}


static public class WriteBoardVerify
{
