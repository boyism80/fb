...
public struct Account : IFlatbufferObject
{
  ...
  public static Offset<fb.protocol.db.request.origin.Account> CreateAccount(FlatBufferBuilder builder,
      uint uid = 0) {
  ...
  public static Offset<fb.protocol.db.request.origin.Account> EndAccount(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<fb.protocol.db.request.origin.Account>(o);
  }
  public static void FinishAccountBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.Account> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedAccountBuffer(FlatBufferBuilder builder, Offset<fb.protocol.db.request.origin.Account> offset) { builder.FinishSizePrefixed(offset.Value); }
}
