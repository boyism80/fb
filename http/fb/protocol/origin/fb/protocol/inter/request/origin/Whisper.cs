...
public struct Whisper : IFlatbufferObject
{
  ...
  public static void FinishWhisperBuffer(FlatBufferBuilder builder, Offset<fb.protocol.inter.request.origin.Whisper> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedWhisperBuffer(FlatBufferBuilder builder, Offset<fb.protocol.inter.request.origin.Whisper> offset) { builder.FinishSizePrefixed(offset.Value); }
}
