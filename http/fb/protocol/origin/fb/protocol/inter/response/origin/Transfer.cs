...
public struct Transfer : IFlatbufferObject
{
  ...
  public fb.protocol.inter.origin.TransferResult Code { get { int o = __p.__offset(4); return o != 0 ? (fb.protocol.inter.origin.TransferResult)__p.bb.GetSbyte(o + __p.bb_pos) : fb.protocol.inter.origin.TransferResult.Success; } }
  ...
  public static Offset<fb.protocol.inter.response.origin.Transfer> CreateTransfer(FlatBufferBuilder builder,
      fb.protocol.inter.origin.TransferResult code = fb.protocol.inter.origin.TransferResult.Success,
  ...
  public static void AddCode(FlatBufferBuilder builder, fb.protocol.inter.origin.TransferResult code) { builder.AddSbyte(0, (sbyte)code, 0); }
...
static public class TransferVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*Code*/, 1 /*fb.protocol.inter.origin.TransferResult*/, 1, false)
