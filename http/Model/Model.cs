...
namespace Fb.Model.ConstValue
{
    ...
    public static class String
    {
        ...
        public const string MessageAssetMapLoaded = "* [%0.2lf%%] 맵 정보를 읽었습니다. (%s)";
        public const string MessageAssetRegexLoaded = "* [%0.2lf%%] 정규표현식 정보를 읽었습니다. (%s)";
        public const string MessageAssetWorldMapLoaded = "* [%0.2lf%%] 월드맵 정보를 읽었습니다. (%s)";
        public const string MessageAssetDoorLoaded = "* [%0.2lf%%] 도어 정보를 읽었습니다. (%s)";
        public const string MessageAssetSpellLoaded = "* [%0.2lf%%] 스펠 정보를 읽었습니다. (%s)";
        public const string MessageAssetWarpLoaded = "* [%0.2lf%%] 워프 정보를 읽었습니다. (%s)";
        public const string MessageAssetItemLoaded = "* [%0.2lf%%] 아이템 정보를 읽었습니다. (%s)";
        public const string MessageAssetItemMixLoaded = "* [%0.2lf%%] 조합 정보를 읽었습니다. (%s)";
        public const string MessageAssetSellLoaded = "* [%0.2lf%%] 판매 정보를 읽었습니다. (%s)";
        public const string MessageAssetBuyLoaded = "* [%0.2lf%%] 구매 정보를 읽었습니다. (%s)";
        public const string MessageAssetNpcLoaded = "* [%0.2lf%%] NPC 정보를 읽었습니다. (%s)";
        public const string MessageAssetMobLoaded = "* [%0.2lf%%] 몹 정보를 읽었습니다. (%s)";
        public const string MessageAssetDropLoaded = "* [%0.2lf%%] 드롭 정보를 읽었습니다. (%s)";
        public const string MessageAssetNpcSpawnLoaded = "* [%0.2lf%%] NPC 스폰 정보를 읽었습니다. (%s)";
        public const string MessageAssetMobSpawnLoaded = "* [%0.2lf%%] 몹 스폰 정보를 읽었습니다. (%s)";
        public const string MessageAssetClassLoaded = "* [%0.2lf%%] 클래스 정보를 읽었습니다. (%s)";
        public const string MessageAssetBoardLoaded = "* [%0.2lf%%] 게시판 정보를 읽었습니다. (%s)";
